...
class StatRenderer {
  ...
  String renderNode(ExecutionNode node, int spaces) {
    ...
    builder.append("<tr style=\"")
        ...
        .append(node.getName())
        .append("</td>")
        .append(showModule ? "<td>" + node.getModule() + "</td>" : "")
        .append(" ")
  ...
  private static void beginStatTable(StringBuilder builder, boolean showModule) {
    builder.append("<table>")
        .append("<tr style=\"font-style: oblique\">")
        .append("<td>Name</td>")
        .append(showModule ? "<td><center>Module</center></td>" : "")
        .append("<td><center>Count</center></td>")
        .append("<td><center>Average<br>(sec)</center></td>")
        .append("<td><center>Lowest<br>(sec)</center></td>")
        .append("<td><center>Highest<br>(sec)</center></td>")
        .append("<td><center>Total<br>(sec)</center></td>")
        .append("</tr>");
  }
