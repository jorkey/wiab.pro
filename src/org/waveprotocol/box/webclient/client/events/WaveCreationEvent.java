...
public class WaveCreationEvent
    extends GwtEvent<WaveCreationEventHandler> {
  
  public static final Type<WaveCreationEventHandler> TYPE =
      new Type<WaveCreationEventHandler>();
  ...
  @Override
  public com.google.gwt.event.shared.GwtEvent.Type<WaveCreationEventHandler>
      getAssociatedType() {
    return TYPE;
  }
}
