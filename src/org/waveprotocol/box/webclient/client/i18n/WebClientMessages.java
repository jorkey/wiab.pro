...
public interface WebClientMessages extends Messages {
  ...
  String changesNotSavedTitle();

  @DefaultMessage("Your last changes are not saved! Do you want to close the current wave?")
  String changesNotSavedMessage();
  ...
  @DefaultMessage("Fatal server error")
  String fatalServerError();
}
