...
public final class FetchProfilesServlet extends HttpServlet {
   ...
   */
  private static ProfileRequest parseProfileRequest(HttpServletRequest req) throws UnsupportedEncodingException {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse response) throws IOException {
    ...
    ProfileRequest profileRequest = parseProfileRequest(req);
