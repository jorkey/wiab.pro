 ...
 * @author David Byttow
 */
public class GadgetRendererImpl implements GadgetRenderer {
  ...
  @Inject
  public GadgetRendererImpl(Provider<HttpServletRequest> requestProvider) {
    this.requestProvider = requestProvider;
  }

  /* (non-Javadoc)
   * @see org.waveprotocol.box.server.rpc.render.web.text.GadgetRenderer#render(com.google.wave.api.Gadget, java.util.List, java.lang.StringBuilder)
   */
  @Override
