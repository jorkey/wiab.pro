...
public final class ViewIdMapper {
  ...
  public String replyBoxOf(ConversationThread t) {
    return modelMapper.threadId(t) + "I";
  }

  public String continuationIndicatorOf(ConversationBlip b) {
    return modelMapper.blipId(b) + "I";
  }  
  ...
  public String tagsOf(Conversation c) {
    return modelMapper.convId(c) + "A";
  }

  public String tagOf(Conversation c, String tag) {
    return modelMapper.tagId(c, tag) + "A";
  }  
  ...
  public Conversation tagsOf(String domId) {
    return modelMapper.locateConversation(baseOf(domId));
  }

  public Pair<Conversation, String> tagOf(String domId) {
    return modelMapper.locateTag(baseOf(domId));
  }  
}
