...
import org.waveprotocol.box.server.rpc.render.view.ReplyIndicatorView;
import org.waveprotocol.box.server.rpc.render.view.ThreadView;
import org.waveprotocol.box.server.rpc.render.view.View;
...
abstract class ThreadViewImpl<
  ...
  public interface Helper<I> {
    ...
    ReplyIndicatorView getIndicator( I thread );
  }
