 ...
 */
public final class HtmlThreadReadStateMonitorImpl implements ThreadReadStateMonitor {
  ...
  private final SupplementedWave supplementedWave;
   ...
   */
  public static HtmlThreadReadStateMonitorImpl create(SupplementedWave supplementedWave,
      ObservableConversationView conversationView) {
    HtmlThreadReadStateMonitorImpl monitor = new HtmlThreadReadStateMonitorImpl(
        supplementedWave, conversationView);
    monitor.init();
    return monitor;
  }

  private HtmlThreadReadStateMonitorImpl(SupplementedWave supplementedWave,
      ObservableConversationView conversationView) {
  ...
  private SupplementedWave getSupplement() {
    SupplementedWave supplement = supplementedWave;
