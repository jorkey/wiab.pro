 ...
 *
 */
package org.waveprotocol.box.server.rpc.render.uibuilder;
...
import static org.waveprotocol.box.server.rpc.render.uibuilder.BuilderHelper.KIND_ATTRIBUTE;
...
public final class OutputHelper {
   ...
   */
  public static void open(SafeHtmlBuilder builder, String id, String clazz,
      String kind) {
   ...
   * @param kind value for the kind attribute (or {@code null} for none)
   */
  public static void openSpan(SafeHtmlBuilder builder, String id, String clazz, 
      String kind) {
  ...
  public static void openSpanWith(SafeHtmlBuilder builder, String id,
      String clazz, String kind, String extra) {
   ...
   */
  public static void append(SafeHtmlBuilder builder, String id, String clazz,
      String kind) {
    appendWith(builder, id, clazz, kind, null, null, null);
  }
   ...
   * @see #open(SafeHtmlBuilder, String, String, String)
   */  
  public static void appendSpan(SafeHtmlBuilder builder, String id,
      String clazz, String kind) {
    appendSpanWith(builder, id, clazz, kind, null, null, null);
  }
  ...
  public static void appendWith(SafeHtmlBuilder builder, String id,
      String clazz, String kind, String extra) {
    appendWith(builder, id, clazz, kind, extra, null, null);
  }
   ...
   * @param clazz
   */
  public static void image(SafeHtmlBuilder builder, String id, String clazz,
      SafeHtml url, SafeHtml info, String kind) {
  ...
  public static void button(SafeHtmlBuilder builder, String id, String clazz,
      String kind, String title, String caption) {
    StringBuilder s = new StringBuilder();
    s.append("<button ");
    if (id != null) {
      s.append("id='").append(id).append("' ");
