...
public class MemoryStore implements SignerInfoStore, AccountStore, ContactStore {
  ...
  private Map<ParticipantId, List<Contact>> contacts = Maps.newHashMap();
  ...
  public List<Contact> getContacts(ParticipantId participant) throws PersistenceException {
    return contacts.get(participant);
  }

  @Override
  public void storeContacts(ParticipantId participant, List<Contact> newContacts) throws PersistenceException {
    contacts.put(participant, newContacts);
  }
}
