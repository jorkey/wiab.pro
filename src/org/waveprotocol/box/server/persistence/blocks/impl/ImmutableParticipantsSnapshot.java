 ...
 */
public class ImmutableParticipantsSnapshot extends ImmutableSegmentSnapshot<ReadableParticipantsSnapshot>
    implements ReadableParticipantsSnapshot {

  public ImmutableParticipantsSnapshot(SegmentSnapshot snapshot, ReadableFragment fragment, long version) {
    super(snapshot, fragment, version);
  }

  @Override
  public synchronized ParticipantId getCreator() {
    return getProxy().getCreator();
  }

  @Override
  public synchronized Set<ParticipantId> getParticipants() {
    return getProxy().getParticipants();
  }

  @Override
  public synchronized RawParticipantsSnapshot getRawSnapshot() {
