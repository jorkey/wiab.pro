 ...
 *
 */
public interface LocalWaveletContainer extends WaveletContainer {
   ...
   */
  boolean isDeltaSigner(HashedVersion hashedVersion, ByteString signerId) throws WaveletStateException;
}
