...
import org.waveprotocol.box.server.robots.operations.FolderActionForAllService;
 ...
 */
public class OperationServiceRegistryImpl extends AbstractOperationServiceRegistry {

  // Suppressing warnings about operations that are deprecated but still used by
  // the default client libraries.
  @SuppressWarnings("deprecation")
  @Inject
  OperationServiceRegistryImpl(Injector injector, NotifyOperationService notifyOpService) {
    super();
    ...
    register(OperationType.WAVELET_MODIFY_PARTICIPANT_ROLE, ParticipantServices.create());
    ...
    register(OperationType.WAVELET_MODIFY_TAG, BlipOperationServices.create());
    ...
    register(OperationType.DOCUMENT_MODIFY, injector.getInstance(DocumentModifyService.class));
    ...
    register(OperationType.ROBOT_FOLDER_ACTION_FOR_ALL, FolderActionForAllService.create());
  }
}
