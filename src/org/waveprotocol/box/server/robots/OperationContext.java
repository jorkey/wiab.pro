...
public interface OperationContext {
   ...
   */
  ReadableWaveletData getWaveletSnapshot(WaveletName waveletName,
        ParticipantId participant) throws InvalidRequestException;

  /**
   * Takes wavelet snapshot of specified version, checking access for the given participant.
   *
   * @param waveletName the wavelet name of the wavelet to get.
   * @param participant the user.
   * @return snapshot on success, null on failure
   */
  ReadableWaveletData getWaveletSnapshot(WaveletName waveletName,
        HashedVersion version, ParticipantId participant) throws InvalidRequestException;
  ...
  void getDeltas(WaveletName waveletName, ParticipantId participant,
    ...
    ThrowableReceiver<WaveletDeltaRecord, InvalidRequestException> receiver)
    throws InvalidRequestException;
}
