 ...
 */
public final class LoggingRequestListener implements SubmitRequestCallback {
  ...
  public void onFailure(ReturnCode responseCode, String errorMessage) {
    log.warning("Robot operations failed to be submitted: "
        + responseCode.toString() + " : " + errorMessage);
  }
