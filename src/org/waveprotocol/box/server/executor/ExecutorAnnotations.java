...
public interface ExecutorAnnotations {
  ...
  @Retention(RUNTIME)
  @BindingAnnotation
  public @interface ClientFrontendExecutor {
  }
  ...
  @Retention(RUNTIME)
  @BindingAnnotation
  public @interface StorageIndexingExecutor {
  }
  ...
  @Retention(RUNTIME)
  @BindingAnnotation
  public @interface WaveletLoadingExecutor {
  }
  ...
  @Retention(RUNTIME)
  @BindingAnnotation
  public @interface BlockPersistExecutor {
  }
