...
public class RegistrationUtil {
  ...
  public static boolean createAccountAndGreeting(AccountStore accountStore, ParticipantId id,
  ...
  public static void createGreetingIfNotExists(ParticipantId id, WelcomeRobot welcomeBot) {
    try {
      welcomeBot.greet(id);
    } catch (IOException e) {
      LOG.warning("Failed to create a welcome wavelet for " + id, e);
