...
public interface WaveletDeltaChannel extends WaveletChannel.Listener {
  ...
  public interface Receiver {
     ...
     * @param operations the changes in the initialized fragments since connect version
