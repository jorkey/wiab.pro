...
class OperationChannelImpl implements InternalOperationChannel {
   ...
   */
  private final ServerConnection ccServerConnection =
  ...
  @Override
  public void onConnection(HashedVersion connectVersion, HashedVersion lastModifiedVersion, HashedVersion unacknowledgedDeltaVersion, 
    ...
    try {
      cc.onOpen(connectVersion, lastModifiedVersion, operations, unacknowledgedDeltaVersion);
    } catch (TransformException ex) {
      throw new ChannelException(ReturnCode.INVALID_OPERATION,
          "Operation channel failed on diff operations: " + this + ", " + deltaChannel + ", " + cc,
          ex, Recoverable.NOT_RECOVERABLE, null, null);
    } catch (OperationException ex) {
      throw new ChannelException(
          ex.isSchemaViolation() ? ReturnCode.SCHEMA_VIOLATION : ReturnCode.INVALID_OPERATION,
          "Operation channel failed on diff operations: " + this + ", " + deltaChannel + ", " + cc,
          ex, Recoverable.NOT_RECOVERABLE, null, null);
    }
  }
  ...
  public void onDelta(TransformedWaveletDelta delta) throws ChannelException {
    try {
      ...
      throw new ChannelException(
          e.isSchemaViolation() ? ReturnCode.SCHEMA_VIOLATION : ReturnCode.INVALID_OPERATION,
          "Operation channel failed on server delta: " + this + ", " + deltaChannel + ", " + cc,
          e, Recoverable.NOT_RECOVERABLE, null, null);
    }
  }
  ...
  public void onNack(ReturnStatus detail, long version) throws ChannelException {
    throw new ChannelException(detail.getCode(),
        "Operation channel failed on nack: error = " + detail + ", " + this + ", " + deltaChannel + ", " + cc,
  ...
  public void send(WaveletOperation... operations) throws ChannelException {
    if (state == State.CLOSED) {
      ...
      throw new ChannelException(ReturnCode.NOT_AUTHORIZED,
