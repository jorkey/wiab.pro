...
public class OperationSucker implements OperationChannel.Listener {
   ...
   */
  public static OperationSucker start(OperationChannel channel, FlushingOperationSink<WaveletOperation> sink) {
    OperationSucker operationSucker = new OperationSucker(channel, sink);
    channel.setListener(operationSucker);
    return operationSucker;
  }
   ...
   */
  private OperationSucker(OperationChannel channel, FlushingOperationSink<WaveletOperation> sink) {
