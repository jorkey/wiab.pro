...
public class ChannelException extends Exception {
  ...
  private final ReturnCode responseCode;
   ...
   */
  public ChannelException(ReturnCode responseCode, String message, Throwable cause,
  ...
  public ChannelException(String message, Recoverable isRecoverable) {
    this(ReturnCode.INTERNAL_ERROR, message, null, isRecoverable, null, null);
  }
   ...
   */
  public ReturnCode getResponseCode() {
    return responseCode;
  }
