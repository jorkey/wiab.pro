...
public class UserDataSchemas implements SchemaProvider {
  ...
  public UserDataSchemas() {
    ...
    schemas.put(WaveletBasedSupplement.LOOKSTATE_DOCUMENT, UDW_LOOK);
   ...
   * User Data Wavelet read/unread versions document schema constraints.
   */
  public static final DocumentSchema UDW_LOOK = new AbstractXmlSchemaConstraints() {
    {
      addChildren(null, WaveletBasedSupplement.WAVELET_TAG);

      addChildren(WaveletBasedSupplement.WAVELET_TAG, WaveletBasedSupplement.BLIP_LOOK_TAG);
      addChildren(WaveletBasedSupplement.WAVELET_TAG, WaveletBasedSupplement.WAVELET_LOOK_TAG);

      addAttrs(WaveletBasedSupplement.WAVELET_TAG, WaveletBasedSupplement.ID_ATTR);
      
      addAttrs(WaveletBasedSupplement.BLIP_LOOK_TAG, WaveletBasedSupplement.ID_ATTR);
      addAttrs(WaveletBasedSupplement.BLIP_LOOK_TAG, WaveletBasedSupplement.VERSION_ATTR);
      
      addAttrs(WaveletBasedSupplement.WAVELET_LOOK_TAG, WaveletBasedSupplement.VERSION_ATTR);
    }
