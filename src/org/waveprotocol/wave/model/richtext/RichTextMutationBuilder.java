...
public class RichTextMutationBuilder {
    ...
    if (currentStructureType != null) {
      ...
      if (tokenizer.getCurrentType() == Type.LIST_ITEM) {
        ...
        case UNORDERED_LIST_START:
          indent--;
          attrList.add(new Attribute(AnnotationConstants.TEXT_TYPE, "li"));
          break;
        case ORDERED_LIST_START:
          indent--;
          attrList.add(new Attribute(AnnotationConstants.TEXT_TYPE, "li"));
          attrList.add(new Attribute(AnnotationConstants.TEXT_LI_STYLE, "decimal"));
          break;
        }
      } else if (tokenizer.getData() != null) {
        attrList.add(new Attribute(AnnotationConstants.TEXT_TYPE, tokenizer.getData()));
      }

      if (indent > 0) {
        attrList.add(new Attribute(AnnotationConstants.TEXT_INDENT, "" + indent));
      }
    }
  ...
  private <N, E extends N, T extends N> boolean lcCanHandleNewLine(ReadableDomDocument<N, E, T> doc,
      N container) {
