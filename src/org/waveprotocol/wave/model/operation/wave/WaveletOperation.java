 ...
 *
 */
public abstract class WaveletOperation implements ReversibleOperation<WaveletOperation, WaveletData>, 
    Visitable<WaveletOperationVisitor> {
  ...
  public VersionUpdateOp createVersionUpdateOp() {
    return new VersionUpdateOp(context.getCreator(), null, 
      context.getSegmentVersion(), context.getHashedVersion());
  }
  ...
  public VersionUpdateOp createVersionUpdateOp(long segmentVersion, HashedVersion hashedVersion) {
    if (isWorthyOfAttribution()) {
      return new VersionUpdateOp(context.getCreator(), null, segmentVersion, hashedVersion);
    } else {
  ...
  protected final WaveletOperationContext createReverseContext(WaveletData target) {
    return new WaveletOperationContext(context.getCreator(), 
      target.getLastModifiedTime(), target.getHashedVersion().getVersion(), target.getHashedVersion());
  }
