...
public final class NoOp extends WaveletOperation {
  ...
  public List<? extends WaveletOperation> applyAndReturnReverse(WaveletData target)
    ...
    apply(target);
    return reverse(createReverseContext(target));
  }

  @Override
  public List<? extends WaveletOperation> reverse(WaveletOperationContext newContext) {
    WaveletOperation reverse = new NoOp(newContext);
