...
public final class RemoveParticipant extends WaveletOperation {
  ...
  public void doApply(WaveletData target) throws OperationException {
    if (!target.removeParticipant(participant, getContext()) ) {
  ...
  @Override
  public List<? extends WaveletOperation> reverse(WaveletOperationContext reverseContext) {
    return Collections.singletonList(new AddParticipant(reverseContext, participant));
  }
