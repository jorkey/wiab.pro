...
public interface DocumentSchema {
  ...
  public enum PermittedCharacters {
    ...
    BLIP_TEXT {
      ...
      public String coerceString(String string) {
        ...
        Utf16Util.traverseUtf16String(string,
            new CodePointHandler<Void>() {
  ...
  /**
   * True if childType elements are permitted to occur as children of parentTypeOrNull,
   ...
   */
  boolean permitsAttribute(
      String type, String attributeName, String attributeValue);
