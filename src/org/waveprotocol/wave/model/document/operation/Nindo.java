...
public final class Nindo {
  ...
  //
  // Static methods creating Nindo's reflecting given changes in the document
  //
  ...
  public static Nindo insertCharacters(int location, String characters) {
    ...
    addSkipIfNecessary(mutationList, location);
    mutationList.add(new Characters(characters));
    return new Nindo(mutationList);
  }
   ...
   * @return The document mutation.
   */
  public static Nindo insertElement(
      int location, String tagName, Attributes attributes) {
  ...
  public static Nindo deleteCharacters(int start, int end) {
    List<MutationComponent> mutationList = new ArrayList<MutationComponent>(2);
    addSkipIfNecessary(mutationList, start);
  ...
  public static Nindo deleteElement(int elementLocation) {
    ...
    // that elsewhere.
    addSkipIfNecessary(mutationList, elementLocation);
    mutationList.add(DeleteElementStart.INSTANCE);
    mutationList.add(DeleteElementEnd.INSTANCE);
    return new Nindo(mutationList);
  }
  ...
  public static Nindo setAttribute(int location, String name, String value) {
    List<MutationComponent> mutationList = new ArrayList<MutationComponent>(2);
    addSkipIfNecessary(mutationList, location);
    mutationList.add(new UpdateAttributes(
  ...
  public static Nindo removeAttribute(int location, String name) {
    ...
    addSkipIfNecessary(mutationList, location);
    mutationList.add(new UpdateAttributes(
        Collections.singletonMap(name, (String)null)));
    return new Nindo(mutationList);
  }
   ...
   * @return The document mutation.
   */
  public static Nindo setAnnotation(
      int start, int end, String key, String value) {
  ...
  public static <N, E extends N, T extends N>
      AnnotationBuilder<N, E, T> annotationBuilder(
  ...
  /**
   * Adds a skip of the given size to the start of the nindo if distance is
      ...
      if (remaining > 0) {
        if (c instanceof Skip) {
          ...
          Preconditions.illegalArgument(
              "Not enough initial skips in nindo to take off");
        }
      } else {
        c.apply(b);
      }
...
//  }
  ...
  public String toString() {
    ...
    apply(new NindoCursor() {
      ...
      @Override
      public void skip(int skipSize) {
        builder.append("__").append(skipSize).append("; ");
      }

      @Override
      public void characters(String characters) {
        builder.append("++").append(toLiteral(characters)).append("; ");
      }

      @Override
      public void elementStart(String tagName, Attributes attributes) {
        builder.append("<< ").append(tagName).append(" ").append(attributes)
            .append("; ");
      }
      ...
      @Override
      public void deleteCharacters(int deletionSize) {
        builder.append("--").append(deletionSize).append("; ");
      }
      ...
      @Override
      public void replaceAttributes(Attributes attributes) {
        builder.append("s@ ").append(attributes).append("; ");
      }

      @Override
      public void updateAttributes(Map<String, String> attributes) {
        builder.append("u@ ").append(attributes).append("; ");
      }

      @Override
      public void startAnnotation(String key, String value) {
        builder.append("(( ").append(key).append("=")
            .append(value == null ? "null" : toLiteral(value)).append("; ");
      }
  ...
  static private void addSkipIfNecessary(
      List<MutationComponent> mutationList, int location) {
    if (location > 0) {
