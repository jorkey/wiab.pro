...
import org.waveprotocol.wave.model.document.dom.TextNodeOrganiser;
...
public class DocHelper {
  ...
  public static <N, E extends N, T extends N> boolean textPrecedes(
      ReadableDomDocument<N, E, T> doc, LocationMapper<N> mapper, int location) {
  ...
  public static <N, E extends N> E getElementWithTagName(
      ReadableDomDocument<N, E, ?> doc, String tagName) {
   ...
   *         exist
   */
  public static <N, E extends N> E getElementWithTagName(ReadableDomDocument<N, E, ?> doc,
   ...
   */
  public static <N, E extends N> E getLastElementWithTagName(ReadableDomDocument<N, E, ?> doc,
      String tagName, E subtreeRoot) {
   ...
   * Get the text within the given element.
   */
  public static <N, E extends N, T extends N> String getText(ReadableDomDocument<N, E, T> doc,
   ...
   * @see DocHelper#getElementWithTagName(ReadableDomDocument, String)
   * @see DocHelper#getText(ReadableDomDocument, LocationMapper, Object)
   */
  public static <N> String getTextForElement(
      ReadableDocument<N, ?, ?> doc, String tagName) {
  ...
  public static <N, E extends N, T extends N> String getTextForElement(
        ReadableDomDocument<N, E, T> doc, LocationMapper<N> mapper, String tagName) {
   ...
   * @see #getText(ReadableDomDocument, LocationMapper, int, int)
   */
  public static <N> String getText(ReadableDocument<N, ?, ?> doc, int start, int end) {
    return getText(doc, doc, start, end);
  }

  /**
   * Gets text between two locations, using a mapper to convert to points.
   * @see #getText(ReadableDomDocument, Point, Point)
   */
  public static <N, E extends N, T extends N> String getText(
      ReadableDomDocument<N, E, T> doc, LocationMapper<N> mapper,
      int start, int end) {
  ...
  public static <N, E extends N, T extends N> String getText(
      ReadableDomDocument<N, E, T> doc, Point<N> startPoint, Point<N> endPoint) {
  ...
  private static <N, E extends N, T extends N> void getNodeAfterOutwards(
      ReadableDomDocument<N, E, T> doc, Point<N> point, NodeOffset<N> output) {
    N node;
    int startOffset;
    if (point.isInTextNode()) {
  ...
  public static <N> N getNextNodeDepthFirst(
      ReadableDomDocument<N, ?, ?> doc, N start, N stopAt, boolean enter) {
    return getNextOrPrevNodeDepthFirst(doc, start, stopAt, enter, true);
  }

  /**
   * Same as {@link #getNextNodeDepthFirst(ReadableDomDocument, Object, Object, boolean)},
  ...
  /**
   * Same as {@link #getNextNodeDepthFirst(ReadableDomDocument, Object, Object, boolean)}
   * and {@link #getPrevNodeDepthFirst(ReadableDomDocument, Object, Object, boolean)}
  ...
  public static <N, E extends N, T extends N> N getNextOrPrevNodeDepthFirst(
      ReadableDomDocument<N, E, T> doc, N start, N stopAt, boolean enter, boolean rightwards) {
  ...
  public static <N, T extends N> int getItemSize(ReadableDocument<N, ?, T> doc, N node) {
  ...
  public static <N, E extends N, T extends N> Point<N> leftAlign(Point<N> current,
      ReadableDomDocument<N, E, T> fullDoc, ReadableDocumentView<N, E, T> important) {
   ...
   *         otherwise {@code null}.
   */
  public static <N, E extends N> E getFirstChildElement(ReadableDomDocument<N, E, ?> doc, E element) {
   ...
   *         otherwise {@code null}.
   */
  public static <N, E extends N> E getLastChildElement(ReadableDomDocument<N, E, ?> doc, E element) {
   ...
   *         otherwise {@code null}.
   */
  public static <N, E extends N> E getNextSiblingElement(ReadableDomDocument<N, E, ?> doc, E element) {
   ...
   */
  public static <N, E extends N> E getNextElementInclusive(ReadableDomDocument<N, E, ?> doc, N node,
      boolean forward) {
   ...
   */
  public static <N, E extends N, T extends N> void traverse(ReadableDomDocument<N, E, T> doc, N node,
  ...
  public static <N, T extends N> Point.El<N> ensureNodeBoundary(Point<N> point,
      ReadableDomDocument<N, ?, T> doc, TextNodeOrganiser<T> textNodeOrganiser) {
  ...
  public static <N, E extends N, T extends N> int countChildren(
      ReadableDomDocument<Node, Element, Text> doc, Element elem) {
    int children = 0;
  ...
  public static <N, E extends N, T extends N> E findElementById(
      ReadableDomDocument<N, E, T> doc, E subtreeRoot, String id) {
   ...
   */
  public static <N, E extends N, T extends N> E findElementById(
      ReadableDomDocument<N, E, T> doc, String id) {
  ...
  public static <N, E extends N, T extends N> E findElementByAttr(
      ReadableDomDocument<N, E, T> doc, E subtreeRoot, String name, String value) {
   ...
   */
  public static <N, E extends N, T extends N> E findElementByAttr(
      ReadableDomDocument<N, E, T> doc, String name, String value) {
   ...
   *
   * @see #findElementByAttr(ReadableDomDocument, String, String)
   *
  ...
  public static final DocPredicate ROOT_PREDICATE = new DocPredicate() {
    @Override
    public <N, E extends N, T extends N> boolean apply(ReadableDomDocument<N, E, T> doc, N node) {
  ...
  public static <N, E extends N> boolean isMatchingElement(
      final ReadableDomDocument<N, E, ?> doc, N node, String tagName) {
  ...
  public static <N, E extends N, T extends N> Point<N> jumpOut(
      ReadableDomDocument<N, E, T> doc, Point<N> location, DocPredicate predicate) {
    E el;
    N nodeAfter;
  ...
  public static <N, E extends N, T extends N> N nearestCommonAncestor(
      ReadableDomDocument<N, E, T> doc, N node1, N node2) {
  ...
  public static <N, E extends N, T extends N>
      boolean isAncestor(ReadableDomDocument<N, E, T> doc, N ancestor, N child, boolean canEqual) {
