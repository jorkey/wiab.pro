...
public abstract class XmlStringBuilder {
   ...
   */
  public static <N> XmlStringBuilderDoc<N, ?, ?> innerXml(ReadableDomDocument<N, ?, ?> doc) {
    //
    // NOTE(user):
  ...
  private static <N, E extends N, T extends N> XmlStringBuilderDoc<N, E, T>
      innerXml1(ReadableDomDocument<N, E, T> doc) {
  ...
  private static <N, E extends N, T extends N> XmlStringBuilderDoc<N, E, T> innerXmlHelper(
      ReadableDomDocument<N, E, T> doc, PermittedCharacters permittedChars) {
   ...
   */
  public static <N> XmlStringBuilderDoc<N, ?, ?> outerXml(ReadableDomDocument<N, ?, ?> doc) {
    //
    // NOTE(user):
    // This two-step unravelling of re-quantifying the type-parameters into type variables
    // is only required in order to coax javac's dumb generic-inference to realise that the call is
  ...
  public static <N, E extends N, T extends N> XmlStringBuilderDoc<N,E,T>
      createEmpty(ReadableDomDocument<N, E, T> view) {
   ...
   */
  public static <N, E extends N, T extends N> XmlStringBuilderDoc<N,E,T>
      createNode(ReadableDomDocument<N, E, T> view, N node) {
   ...
   */
  public static <N, E extends N, T extends N> XmlStringBuilderDoc<N,E,T>
      createChildren(ReadableDomDocument<N, E, T> view, E element) {
   ...
   */
  public static <N, E extends N, T extends N> XmlStringBuilderDoc<N,E,T>
      createText(ReadableDomDocument<N, E, T> view, String text) {
