...
public class XmlStringBuilderDoc<N, E extends N, T extends N> extends XmlStringBuilder {
  ...
  private final ReadableDomDocument<N, E, T> view;

  private final PermittedCharacters permittedChars;

  private XmlStringBuilderDoc(ReadableDomDocument<N, E, T> view, PermittedCharacters permittedChars) {
    this.view = view;
   ...
   */
  public static <N, E extends N, T extends N> XmlStringBuilderDoc<N,E,T>
      createEmptyWithCharConstraints(ReadableDomDocument<N, E, T> view, PermittedCharacters permittedChars) {
