...
//      void onFinish();
    ...
    DomDocument<N, E, T> getFullRawDoc();

    DomDocument<N, E, T> getPersistentRawDoc();
  ...
  public static class LocalDocImpl<N, E extends N, T extends N> extends IdentityView<N, E, T>
    ...
    public LocalDocImpl(DomDocument<N, E, T> fullDoc, WritableLocalDocument<N, E, T> local) {
      super(fullDoc);
      this.writable = local;
    }
  ...
  public static TestDocumentContext<Node, Element, Text> createTestPojoContext(
    ...
    TestDocumentContext<Node, Element, Text> documentContext =
        new TestDocumentContext<Node, Element, Text>() {
          private final DomDocument<Node, Element, Text> fullDoc =
...
//              }
          ...
          @Override
          public DomDocument<Node, Element, Text> getFullRawDoc() {
            return fullDoc;
          }
          
          @Override
          public DomDocument<Node, Element, Text> getPersistentRawDoc() {
            return persistentDoc;
          }          
        };
