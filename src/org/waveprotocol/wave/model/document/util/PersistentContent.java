...
public class PersistentContent<N, E extends N, T extends N>
    ...
    implements DomDocument<N, E, T>, WritableLocalDocument<N, E, T> {
   ...
   */
  public PersistentContent(DomDocument<N, E, T> fullDoc, ElementManager<E> elementManager) {
    super(fullDoc);
