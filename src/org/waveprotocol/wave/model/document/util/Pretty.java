...
public class Pretty<N> {
   ...
   */
  public <E extends N, T extends N> String print(ReadableDomDocument<N, E, T> doc) {
    clear();
    appendDocument(doc);
   ...
   */
  public <E extends N, T extends N> String print(ReadableDomDocument<N, E, T> doc, N node) {
    clear();
    appendNode(doc, node);
    return builder.toString();
  }
  ...
  private <E extends N, T extends N>
      void appendDocument(ReadableDomDocument<N, E, T> doc) {
  ...
  private <E extends N, T extends N> void appendTagName(
      ReadableDomDocument<N, E, T> doc, E element) {
   ...
   */
  private <E extends N, T extends N> void appendStartTag(
      ReadableDomDocument<N, E, T> doc, E element, boolean selfClosing) {
    append("<");
  ...
  private <E extends N, T extends N> void appendText(
      ReadableDomDocument<N, E, T> doc, T text) {
