...
public class DocIterate {
  ...
  public interface DocIterationFilter<V, N, E extends N, T extends N> {
     ...
     */
    N next(ReadableDomDocument<N, E, T> doc, N current, N stopAt);
     ...
     */
    V value(ReadableDomDocument<N, E, T> doc, N node);
  }
  ...
  public static <V, N, E extends N, T extends N> Iterable<V> iterate(
      final ReadableDomDocument<N, E, T> doc, final N startNode, final N stopAt,
  ...
  static class DeepIteratorFilter implements DocIterationFilter<Object, Object, Object, Object> {
    ...
    @Override
    public Object next(ReadableDomDocument<Object, Object, Object> doc,
        Object current, Object stopAt) {
      return DocHelper.getNextOrPrevNodeDepthFirst(doc, current, stopAt, true, rightwards);
    }
    @Override
    public Object value(ReadableDomDocument<Object, Object, Object> doc, Object node) {
      return node;
    }
  }
  ...
  /**
   * Iterates using
   * {@link DocHelper#getNextNodeDepthFirst(ReadableDomDocument, Object, Object, boolean)}
  ...
  /**
   * Iterates using
   * {@link DocHelper#getPrevNodeDepthFirst(ReadableDomDocument, Object, Object, boolean)}
   * The parameters to this method match those for that method.
   *
   * @param doc
   * @param startNode
  ...
  /**
   * Same as {@link #deep(ReadableDomDocument, Object, Object)}, but filters out
   * non-elements
   */
  public static <N, E extends N, T extends N> Iterable<E> deepElements(
      final ReadableDomDocument<N, E, T> doc, final E startNode, final E stopAt) {
    return iterate(doc, startNode, stopAt, DocIterate.<N, E, T>forwardDepthFirstElementIterator());
  }

  /**
   * Same as {@link #deepReverse(ReadableDomDocument, Object, Object)}, but filters out
   * non-elements
   */
  ...
  /** See {@link #deepElementsWithTagName(ReadableDomDocument, String, Object, Object)}. */
  public static <N, E extends N, T extends N> Iterable<E> deepElementsWithTagName(
      final ReadableDomDocument<N, E, T> doc, String tagName) {
    return deepElementsWithTagName(
        doc, tagName, DocHelper.getElementWithTagName(doc, tagName), null);
  }

  /**
   * Same as {@link #deepElements(ReadableDomDocument, Object, Object)}, but filters out
   * elements that do not match the given tag name.
   *
   * @return an iterable used for iterating matching elements.
   */
  public static <N, E extends N, T extends N> Iterable<E> deepElementsWithTagName(
      final ReadableDomDocument<N, E, T> doc, String tagName, final E startNode, final E stopAt) {
