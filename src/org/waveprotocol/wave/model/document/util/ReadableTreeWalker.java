...
public class ReadableTreeWalker<N, E extends N, T extends N> {
  ...
  protected final ReadableDomDocument<N, E, T> document;
   ...
   */
  public ReadableTreeWalker(ReadableDomDocument<N, E, T> document, N rootNode) {
   ...
   */
  public ReadableTreeWalker(ReadableDomDocument<N, E, T> document, Iterable<N> nodeIterable) {
  ...
  public boolean checkWalk(ReadableDomDocument<N, E, T> doc, N root) {
  ...
  public boolean checkWalk(ReadableDomDocument<N, E, T> doc, Iterable<N> nodes) {
    try {
      for (N node : nodes) {
