...
public final class DocCompare {
  ...
  private static class NormalisingView<N, E extends N, T extends N> extends IdentityView<N, E, T> {
    ...
    NormalisingView(ReadableDomDocument<N, E, T> inner, int flags) {
      super(inner);
      this.flags = flags;
    }
   ...
   */
  public static <N1, N2> boolean equivalent(final int flags, ReadableDocument<N1, ?, ?> doc1,
      ReadableDocument<N2, ?, ?> doc2) {
  ...
  public static <N1, E1 extends N1, T1 extends N1,
      ...
      final int flags,
      ReadableDomDocument<N1, E1, T1> doc1, ReadableDomDocument<N2, E2, T2> doc2) {

    checkValidFlags(flags);

    ReadableDomDocument<N1, E1, T1> view1 = new NormalisingView<N1, E1, T1>(doc1, flags);
    ReadableDomDocument<N2, E2, T2> view2 = new NormalisingView<N2, E2, T2>(doc2, flags);
  ...
  public static <N, E extends N, T extends N> boolean equivalent(
      int flags,
      String str, ReadableDomDocument<N, E, T> doc) {
