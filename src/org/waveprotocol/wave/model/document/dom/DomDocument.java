 ...
 * @param <T> Text
 */
public interface DomDocument<N, E extends N, T extends N>
    extends ReadableDomDocument<N, E, T>,
    TextNodeOrganiser<T> {
   ...
   */
  interface Factory<D extends DomDocument<?,?,?>> extends DocumentFactory<D> {
  }

  /**
   * Specialization of {@link ReadableDomDocument.Provider} for {@link RawDocument}.
   *
   * @param <D> document type produced
   */
  interface Provider<D extends DomDocument<?, ?, ?>>
      extends ReadableDomDocument.Provider<D>, DomDocument.Factory<D> {}
}
