 ...
 */
public class DomDocumentParserWithSelection<
    N, E extends N, T extends N, D extends DomDocument<N, E, T>> {
  
  private final DomDocument.Factory<D> factory;
  ...
  public static <N, E extends N, T extends N, D extends DomDocument<N, E, T>>
      DomDocumentParserWithSelection<N, E, T, D> create(DomDocument.Factory<D> factory) {
    return new DomDocumentParserWithSelection<N, E, T, D>(factory);
  }

  private DomDocumentParserWithSelection(DomDocument.Factory<D> factory) {
   ...
   */
  public DomDocument<N, E, T> parse(String xmlString) {
  ...
  private E parseElement(
      SafeXmlPullParser parser, SelectionParsingListener<N> selectionListener,
