 ...
 */
public class DomDocumentParserImpl<N, E extends N, T extends N, D extends DomDocument<N, E, T>>
  ...
  public static <N, E extends N, T extends N, D extends DomDocument<N, E, T>>
      DomDocumentParserImpl<N, E, T, D> create(DomDocument.Factory<D> factory) {
    return new DomDocumentParserImpl<N, E, T, D>(factory);
  }
   ...
   */
  private DomDocumentParserImpl(DomDocument.Factory<D> factory) {
