 ...
 *
 */
public interface ObservableMutableDocument<N, E extends N, T extends N>
    extends MutableDocument<N, E, T>, SourcesEvents<DocumentHandler<N, E, T>> {
  ...
  public interface Action {
     ...
     * execution.
     */
    <N, E extends N, T extends N> void exec(
  ...
  public interface Method<V> {
     ...
     * execution.
     */
    <N, E extends N, T extends N> V exec(
        ObservableMutableDocument<N, E, T> doc);
  }
