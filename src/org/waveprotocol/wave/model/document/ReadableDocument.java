 ...
 */
public interface ReadableDocument<N, E extends N, T extends N> extends
    ReadableDomDocument<N, E, T>,
   ...
   *
   * If a document is based on an inner ReadableDocument, it should delegate
