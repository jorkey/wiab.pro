...
public final class MutableDocumentListenerAdapter implements DocHandler {
  ...
  public MutableDocumentListenerAdapter(MutableDocumentListener listener, ObservableDocument doc) {
    this.doc = doc;
    this.listener = listener;
  }

  public static <N> void observe(MutableDocumentListener listener, ObservableDocument doc) {
    doc.addListener(new MutableDocumentListenerAdapter(listener, doc));
  }

  @Override
  public void onDocumentEvents(
      DocHandler.EventBundle<Doc.N, Doc.E, Doc.T> event, WaveletOperationContext opContext) {
