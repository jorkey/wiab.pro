 ...
 */
public interface ReadableDomDocument<N, E extends N, T extends N> {

  /**
   * Specialization of {@link DocumentProvider} for {@link ReadableDomDocument}.
   *
   * @param <D> document type produced
   */
  interface Provider<D extends ReadableDomDocument<?,?,?>>
      extends DocumentProvider<D> {
  }  
