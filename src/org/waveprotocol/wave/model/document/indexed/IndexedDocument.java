...
public interface IndexedDocument<N, E extends N, T extends N> extends
    ReadableDocument<N, E, T>, TextNodeOrganiser<T>, SuperSink {

  /**
   * Specialization of {@link ReadableDomDocument.Provider} for {@link IndexedDocument}.
   *
   * @param <D> document type produced
   */
  interface Provider<D extends IndexedDocument<?,?,?>>
      extends ReadableDomDocument.Provider<D> {
