 ...
 *
 */
public class IndexedDocProvider<N, E extends N, T extends N, D extends DomDocument<N, E, T>>
    implements IndexedDocument.Provider<IndexedDocument<N, E, T>> {

  private final DomDocument.Provider<D> substrateProvider;
  ...
  public static <N, E extends N, T extends N, D extends DomDocument<N, E, T>>
      IndexedDocProvider<N, E, T, D> create(DomDocument.Provider<D> substrateProvider) {
    return new IndexedDocProvider<N, E, T, D>(substrateProvider);
  }

  private IndexedDocProvider(DomDocument.Provider<D> substrateProvider) {
  ...
  public IndexedDocument<N, E, T> create(String tag, Map<String, String> attributes) {
    return adapt(((DomDocument.Factory<D>) substrateProvider).create(tag, attributes),
