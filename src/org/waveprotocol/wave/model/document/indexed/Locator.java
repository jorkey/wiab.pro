...
public class Locator {
   ...
   */
  public static <N> int before(ReadableDocument<N, ?, ?> doc, N node) {
   ...
   */
  public static <N> int after(ReadableDocument<N, ?, ?> doc, N node) {
   ...
   */
  public static <N, E extends N> int start(ReadableDocument<N, E, ?> doc, E element) {
   ...
   */
  public static <N, E extends N> int end(ReadableDocument<N, E, ?> doc, E element) {
