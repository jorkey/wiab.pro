...
public class IndexedDocumentImpl<N, E extends N, T extends N, V>
   ...
   */
  private final DomDocument<N, E, T> substrate;
   ...
   */
  public IndexedDocumentImpl(DomDocument<N, E, T> substrate,
  ...
  private void endChange(WaveletOperationContext opContext) throws OperationException {
...
//          assert value != null;
  ...
  protected void afterFinish(WaveletOperationContext opContext) {
  }
