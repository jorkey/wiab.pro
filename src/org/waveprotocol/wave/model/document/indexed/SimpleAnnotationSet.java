...
public class SimpleAnnotationSet implements RawAnnotationSet<Object> {
   ...
   * appropriate.
   */
  private final ContainerTraverser paintingTraverser =
      new ContainerTraverser() {
  ...
  private final ContainerTraverser skipTraverser =
      new ContainerTraverser() {
        
        @Override
        public void partialContainer(
            Container<Values> container, int startOffset, int endOffset) {
   ...
   */
  private final ContainerTraverser deleteTraverser =
      new ContainerTraverser() {
        
        @Override
        public void partialContainer(
            OffsetList.Container<Values> container, int startOffset, int endOffset) {
          oldValues = container.getValue();
  ...
  public Iterable<AnnotationInterval<Object>> annotationIntervals(int start, int end,
    ...
    if (keys == null) {
      ...
      return
          new Iterable<AnnotationInterval<Object>>() {
