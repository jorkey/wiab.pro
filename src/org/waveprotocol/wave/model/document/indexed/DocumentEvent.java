 ...
 *
 * @param <N> document node type
 * @param <E> document element node type
 * @param <T> document text node type
 */
public abstract class DocumentEvent<N, E extends N, T extends N> {
  ...
  public static final class AttributesModified<N, E extends N, T extends N>
    ...
    public AttributesModified(
        E element, Map<String, String> oldValues,
    ...
    public boolean equals(Object obj) {
      ...
      if (!(obj instanceof AttributesModified)) {
        return false;
      }
      ...
      } else if (!oldValues.equals(other.oldValues)) {
        return false;
      }
      return true;
    }
  ...
  public static final class TextInserted<N, E extends N, T extends N>
    ...
    public int hashCode() {
      final int prime = 31;
      int result = 1;
      result = prime * result + ((insertedText == null) ? 0
          : insertedText.hashCode());
    ...
    public boolean equals(Object obj) {
      ...
      if (!(obj instanceof TextInserted)) {
        return false;
      }
      ...
      } else if (!insertedText.equals(other.insertedText)) {
        return false;
      }
  ...
  public static final class ContentInserted<N, E extends N, T extends N>
    ...
    public boolean equals(Object obj) {
      ...
      if (!(obj instanceof ContentInserted)) {
        return false;
      }
  ...
  public static final class TextDeleted<N, E extends N, T extends N>
    ...
    public int hashCode() {
      final int prime = 31;
      int result = 1;
      result = prime * result + ((deletedText == null) ? 0
    ...
    public boolean equals(Object obj) {
      ...
      } else if (!deletedText.equals(other.deletedText)) {
        return false;
      }
      if (location != other.location) {
        return false;
  ...
  public static final class ContentDeleted<N, E extends N, T extends N>
    ...
    public static final class Token {
      ...
      private Token(
          TokenType type, String tagName, Map<String, String> attributes,
          String text) {
        this.type = type;
      ...
      public String toString() {
        if (text != null) {
          ...
          for (String key : attributes.keySet()) {
            b.append(" ").append(key).append("=").append(attributes.get(key));
          }
          b.append(">");
          return b.toString();
        }
