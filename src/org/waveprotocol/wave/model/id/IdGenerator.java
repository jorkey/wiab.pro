...
/**
 * This class is used to generate Wave and Wavelet id's.
 *
...
public interface IdGenerator {
   ...
   * specified by a leading token "conv" followed by a pseudorandom string,
  ...
  /**
   * Creates an id for a document that is a blip. Generated blip id's take the
   * form "b+[random-token]".
   */
  String newBlipId();

  /**
   * Peeks at what the next blip id will be, providing no other id's are
   * generated.
   *
  ...
  /**
   * Creates an id for a block.
   */
  String newBlockId();

  /**
   * Creates a short, globally unique string token. The token will be distinct
   * from any produced in wave/wavelet/blip/document id's from any instance of
   * this generator.
   */
  String newUniqueToken();

  /**
   * Creates a unique string id with an initial name spacing token. Generated id's
