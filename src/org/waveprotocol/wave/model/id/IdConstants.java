...
public interface IdConstants {
  ...
  /** Symbolic id's for the first and the last blips in the conversation. */
  public static final String FIRST_BLIP_ID = BLIP_PREFIX + TOKEN_SEPARATOR + "$first";
  public static final String LAST_BLIP_ID = BLIP_PREFIX + TOKEN_SEPARATOR + "$last";    
  ...
  public static final String TAGS_DOCUMENT_ID = "tags";

  /** Name of tag element. */
  public static final String TAG_ELEMENT_TYPE = "tag";
