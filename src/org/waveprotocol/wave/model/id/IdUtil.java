...
public class IdUtil implements IdConstants {
   ...
   */
  private static boolean isLegacyBlipId(String id) {
   ...
   */
  public static boolean isGhostBlipId(String id) {
  ...
  public static boolean isTagsDataDocument(String id) {
    return id.equals(TAGS_DOCUMENT_ID);
  }
   ...
   *         ID.
   */
  public static String getUserDataWaveletAddress(WaveletId waveletId) {
   ...
   */
  public static boolean isUserDataWavelet(String address, WaveletId waveletId) {
    return address.equals(getUserDataWaveletAddress(waveletId));
  }

  /**
   * Tests whether a id is a block id.
   */
  public static boolean isBlockId(String id) {
    return hasInitialTokenUnescaped(id, BLOCK_PREFIX);
  }
