...
interface ObservableManifestBlip extends ManifestBlip,
  ...
  public interface Listener {
     ...
     */
    void onReplyAdded(ObservableManifestThread thread, ObservableManifestThread previous,
        WaveletOperationContext opContext);

    /**
     * Called when a reply is going to be removed from the blip.
     */
    void onBeforeReplyRemoved(ObservableManifestThread thread, WaveletOperationContext opContext);

    /**
     * Called when a reply is removed from the blip.
     */
    void onReplyRemoved(ObservableManifestThread thread, WaveletOperationContext opContext);
  }
