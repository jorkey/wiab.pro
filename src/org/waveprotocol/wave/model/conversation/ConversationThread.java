...
public interface ConversationThread {
   ...
   *
   * @param neighbor blip before or after which to insert the new blip
   * @param beforeNeighbor true, if the new blip should be inserted before neighbor blip
   * @return the new blip
   */
  ConversationBlip insertBlip(ConversationBlip neighbor, boolean beforeNeighbor);
  ...
  /**
   * @return true if this thread is root.
   */
  boolean isRoot();

  /**
   * @return true if this thread is inline.
   */
  boolean isInline();
}
