...
public final class DocumentBasedManifest implements ObservableManifest {
   ...
   */
  public static <E> DocumentBasedManifest createOnExisting(ObservableMutableDocument<? super E, E, ?> doc) {
    E top = DocHelper.expectAndGetFirstTopLevelElement(doc, MANIFEST_TOP_TAG);
