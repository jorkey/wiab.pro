...
public final class DocumentBasedSingleton<V, I> implements ObservableSingleton<V, I>,
  ...
  @Override
  public void onElementAdded(Doc.E newElement, WaveletOperationContext opContext) {
  ...
  @Override
  public void onElementRemoved(Doc.E removedElement, WaveletOperationContext opContext) {
