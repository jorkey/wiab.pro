...
public interface ObservableElementList<T, I> extends ElementList<T, I>,
  ...
  public interface Listener<T> {
     ...
     * @param previous value previous to the added; null means insertion into begin
     * @param opContext Document operation context.
     */
    void onValueAdded(T entry, T previous, WaveletOperationContext opContext);

    /**
     * @param entry An existing value that is going to be removed from the list.
     * @param opContext Document operation context.
     */
    void onBeforeValueRemoved(T entry, WaveletOperationContext opContext);

    /**
     * @param entry An existing value that was removed from the list.
     * @param opContext Document operation context.
     */
    void onValueRemoved(T entry, WaveletOperationContext opContext);
  }
}
