 ...
 */
public class HashedVersionZeroFactoryImpl
    implements HashedVersionFactory {
  ...
  public HashedVersion createVersionZero(WaveletName waveletName) {
    try {
      ...
      byte[] historyHash =
          uriCodec.waveletNameToURI(waveletName).getBytes("UTF-8");
      ...
      throw new IllegalStateException(
          "UTF-8 unsupported in creating version zero hash", e);
    }
  }
   ...
   */
  @Override
  public HashedVersion create(
      byte[] appliedDeltaBytes, HashedVersion hashedVersionAppliedAt,
      int operationsApplied) {
    // For lightweight users of this factory there are no deps on crypto code.
    throw new UnsupportedOperationException(
        "This factory can only create hashed version zero.");
  }
}
