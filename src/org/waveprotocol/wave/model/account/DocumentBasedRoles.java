...
public class DocumentBasedRoles implements ObservableRoles {
  ...
  private DocumentBasedRoles(ObservableElementList<
    ...
    this.assignmentListListener = new ObservableElementList.Listener<ObservableAssignment>() {
      @Override
      public void onValueAdded(ObservableAssignment entry, ObservableAssignment previous,
      ...
      @Override
      public void onBeforeValueRemoved(ObservableAssignment entry, WaveletOperationContext opContext) {
      }

      @Override
      public void onValueRemoved(ObservableAssignment entry, WaveletOperationContext opContext) {
