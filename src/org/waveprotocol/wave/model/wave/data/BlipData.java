...
public interface BlipData extends ReadableBlipData {
  ...
  /**
   * Sets the sink to generated operations.
   *
   * @param outputSink
   */
   ...
   */
  void consume(BlipOperation operation) throws OperationException;
  ...
  /**
   * Notifies the BlipData that the tag was added.
   */
  void onTagAdded(String tag, WaveletOperationContext opContext);

  /**
   * Notifies the BlipData that the tag was removed.
   */
