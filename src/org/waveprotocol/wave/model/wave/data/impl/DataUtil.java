...
public final class DataUtil {
  ...
  private static final class RawBlipData extends AbstractBlipData {
    ...
    public RawBlipData(String id, AbstractWaveletData<?> wavelet, DocumentOperationSink content) {
      ...
      super(id, wavelet.getListenerManager(), wavelet.getParticipants().iterator().next(), content,
        0L, -1, 0L, -1);
    }
  ...
  private static final class CoreWrapperWaveletData extends AbstractWaveletData<RawBlipData> {
    ...
    @Override
    protected RawBlipData internalCreateBlip(String docId, ParticipantId author,
    ...
    @Override
    public RawBlipData getBlip(String documentName) {
    ...
    public ImmutableSet<String> getDocumentIds() {
      return ImmutableSet.copyOf(data.getDocuments().keySet());
    }
