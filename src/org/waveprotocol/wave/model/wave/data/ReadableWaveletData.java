...
public interface ReadableWaveletData {
   ...
   */
  ReadableBlipData getBlip(String documentName);

  /**
   * Gets a set of the ids of all non-empty documents in this wavelet.
   */
  ImmutableSet<String> getDocumentIds();
   ...
   */
  ImmutableSet<ParticipantId> getParticipants();

   /**
   * An immutable list of this wave's tags, in the order in which
   * they were added.
   *
   * @return the wavelet's tags.
   */
