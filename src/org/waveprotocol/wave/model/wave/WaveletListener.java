...
public interface WaveletListener {
  ...
  void onParticipantAdded(
      ObservableWavelet wavelet, ParticipantId participant, WaveletOperationContext opContext);
   ...
   * @param opContext wavelet operation context
   */
  void onTagAdded(ObservableWavelet wavelet, String tag, WaveletOperationContext opContext);
   ...
   * @param opContext wavelet operation context
   */
  void onTagRemoved(ObservableWavelet wavelet, String tag, WaveletOperationContext opContext);
   ...
   */
  @Deprecated
  void onRemoteBlipContentModified(Blip blip);
}
