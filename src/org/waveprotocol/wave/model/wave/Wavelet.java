...
public interface Wavelet {
  ...
  /**
   * Adds a tag to this wavelet.  If {@code tag} is already a
   * tag on this wavelet, this method has no effect.
   *
  ...
  /**
   * Removes a tag from this wavelet.  If {@code tag} is not a
   * tag on this wavelet, this method has no effect.
   *
  ...
  /**
   * Gets the tags on this wavelet.
   * The returned set is ordered and not modifiable.
   *
   * @return this wavelet's tags
   */
  Set<String> getTags();
