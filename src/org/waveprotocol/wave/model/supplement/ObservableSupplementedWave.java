...
public interface ObservableSupplementedWave extends SupplementedWave,
  ...
  public interface Listener {
    ...
    /**
     * Notifies this listener that the look state of a blip may have changed.
     *
     * @param blip changed blip
     */
    void onMaybeBlipLookChanged(ObservableConversationBlip blip);
     ...
     * have changed.
     */
    void onMaybeWaveletReadChanged(ObservableConversation conversation);

    /**
     * Notifies this listener that some part of this wavelet's look state may
     * have changed.
     */
    void onMaybeWaveletFirstLookVersionChanged(ObservableConversation conversation);
  ...
  public static class ListenerImpl implements Listener {
    ...
    @Override
    public void onMaybeBlipLookChanged(ObservableConversationBlip blip) {
    }
    ...
    @Override
    public void onMaybeWaveletFirstLookVersionChanged(ObservableConversation conversation) {
    }
