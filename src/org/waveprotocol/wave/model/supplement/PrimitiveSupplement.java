...
public interface PrimitiveSupplement {
  ...
  /**
   * Gets the collection of wavelet ids for which some blip-state exists.
   *
   * @return wavelet ids that have some kind of associated blip state.
   */
  Iterable<WaveletId> getWaveletsWithBlipState();
  ...
  /**
   * @return the first look version of the wavelet
   */
  ...
  /**
   * @return the first look version of a blip, or {@link #NO_VERSION} if none
   *         exists.
   */
   ...
   */
  void setLastReadWaveletVersion(WaveletId waveletId, long version);

  /**
   * Sets the first look version for a wavelet.
   *
   * @param waveletId id of the wavelet
   * @param version override first look version to set
   */
   ...
   */
  void setLastReadBlipVersion(WaveletId waveletId, String blipId, long version);

  /**
   * Sets the first-look version for a blip.
   *
   * @param waveletId  id of the blip's wavelet
   * @param blipId     id of the blip that has been read
   * @param version    wavelet version at which the blip is looked at
   */
   ...
   */
  void setLastReadParticipantsVersion(WaveletId waveletId, long version);
   ...
   */
  void setLastReadTagsVersion(WaveletId waveletId, long version);

  /**
   * Clears the look state of the given wavelet.
   *
   * @param waveletId wavelet id
   */
   ...
   */
  long getArchiveWaveletVersion(WaveletId waveletId);
   ...
   */
  void archiveAtVersion(WaveletId waveletId, long waveletVersion);
   ...
   */
  void setNotifiedVersion(WaveletId waveletId, long version);
