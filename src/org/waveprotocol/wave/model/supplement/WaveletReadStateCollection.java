...
class WaveletReadStateCollection<E> implements ElementListener<E> {
  ...
  private final Map<WaveletId, WaveletReadState> waveletSupplements = new HashMap<>();
  ...
  public static <E> WaveletReadStateCollection<E> create(
    ...
    WaveletReadStateCollection<E> col = new WaveletReadStateCollection<>(router, e, listener);
  ...
  public void onElementAdded(E element, WaveletOperationContext opContext) {
    ...
    if (waveletId != null) {
      ...
      if (existing == null) {
        ...
        //
        long waveletVersion = read.getWaveletLastReadVersion();
        ...
        long participantsVersion = read.getParticipantsLastReadVersion();
        ...
        long tagsVersion = read.getTagsLastReadVersion();
        ...
        for (String blipId : read.getReadBlips()) {
          long blipVersion = read.getBlipLastReadVersion(blipId);
  ...
  void clearBlipReadState(WaveletId waveletId, String blipId) {
    getSupplement(waveletId).clearBlipReadState(blipId);
  }
