...
public interface WritableSupplement {
   ...
   */
  void markBlipAsRead(WaveletId waveletId, String blipId, long version);
   ...
   */
  void markParticipantsAsRead(WaveletId waveletId, long version);
   ...
   */
  void markTagsAsRead(WaveletId waveletId, long version);
   ...
   */
  void markWaveletAsRead(WaveletId waveletId, long version);

  /**
   * Set blip's first looking version.
   * 
   * @param waveletId id of the wavelet
   * @param blipId    id of the blip 
   * @param version   version at which the blip has been looked at
   */
  void setFirstLookBlipVersion(WaveletId waveletId, String blipId, long version);
  
  /**
   * Set wavelet's first looking version.
   * 
   * @param waveletId id of the wavelet that has been looked at
   * @param version   version at which the wavelet has been looked at
   */
   ...
   */
  void archive(WaveletId waveletId, long version);
   ...
   */
  void markWaveletAsNotified(WaveletId waveletId, long version);
