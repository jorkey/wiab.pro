 ...
 */
final class DocumentBasedWaveletThreadState<E>
    implements WaveletThreadState {
  ...
  private final Serializer.EnumSerializer<ThreadState> threadStateSerializer =
      new Serializer.EnumSerializer<ThreadState>(ThreadState.class);
  ...
  private void installListeners(final WaveletId wid, final Listener listener) {
    threadStates.addListener(
        new ObservableBasicMap.Listener<String, ThreadState>() {
