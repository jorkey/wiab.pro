...
public interface ObservablePrimitiveSupplement extends PrimitiveSupplement,
  ...
  public interface Listener {
     ...
     */
    void onLastReadBlipVersionChanged(WaveletId wid, String bid, long oldVersion, long newVersion);

    /**
     * Notifies this listener that the first-look version of a blip has changed.
     */
    void onFirstLookBlipVersionSet(WaveletId wid, String bid, long newVersion);
    
    /**
     * Notifies this listener that the minimum last-read version of all wave
     * parts has changed.
     */
    void onLastReadWaveletVersionChanged(WaveletId wid, long oldVersion, long newVersion);

    /**
     * Notifies this listener that the first look version of wavelet has been changed.
     */
    void onFirstLookWaveletVersionSet(WaveletId wid, long newVersion);        
    
    /**
     * Notifies this listener that the last-read version of the
     * participants-collection has changed.
     */
    void onLastReadParticipantsVersionChanged(WaveletId wid, long oldVersion, long newVersion);

    /**
     * Notifies this listener that the last-read version of the tags has
     * changed.
     */
    void onLastReadTagsVersionChanged(WaveletId wid, long oldVersion, long newVersion);
     ...
     * changed.
     */
    void onArchiveVersionChanged(WaveletId wid, long oldVersion, long newVersion);
    ...
    void onThreadStateChanged(
        WaveletId wid, String tid, ThreadState oldState, ThreadState newState);
    ...
    /**
     * Notifies this listener that focused blip id has been changed.
     */
    void onFocusedBlipIdChanged(WaveletId wid, String oldFocusedBlipId, String newFocusedBlipId);

    /**
     * Notifies this listener that top screen blip id has been changed.
     */
    void onScreenPositionChanged(
