 ...
 */
final class WaveletThreadStateCollection<E>
  ...
  /** Thread state, expressed as a per-wavelet structure. */
  ...
  public Iterable<String> getStatefulThreads(WaveletId waveletId) {
    return waveletSupplements.containsKey(waveletId) ?
        getThreadStateSupplement(waveletId).getThreads() : Collections.<String> emptySet();
  }
  ...
  private WaveletThreadState getThreadStateSupplement(WaveletId waveletId) {
