...
public class JsonHelper {
   ...
   */
  public static native boolean hasProperty(JavaScriptObject object, String key) /*-{
   ...
   */
  public static native void deleteProperty(JavaScriptObject object, String key) /*-{
    delete object[key];
  }-*/;
   ...
   */
  public static native void registerRawStringData(
   ...
   * @return The value of the property.
   */
  public static native String getPropertyAsString(JavaScriptObject object, String key) /*-{
    return object[key];
  }-*/;
   ...
   * @return The value of the property.
   */
  public static native double getPropertyAsDouble(JavaScriptObject object, String key) /*-{
    return object[key];
  }-*/;
   ...
   * @return The value of the property.
   */
  public static native float getPropertyAsFloat(JavaScriptObject object, String key) /*-{
    return object[key];
  }-*/;
   ...
   * @return The value of the property.
   */
  public static long getPropertyAsLong(JavaScriptObject object, String key) {
   ...
   * @return The value of the property.
   */
  public static native int getPropertyAsInteger(JavaScriptObject object, String key) /*-{
    return object[key];
  }-*/;
   ...
   * @return The value of the property.
   */
  public static native boolean getPropertyAsBoolean(JavaScriptObject object, String key) /*-{
    return object[key];
  }-*/;
   ...
   */
  public static native void setPropertyAsObject(JavaScriptObject object, String key,
   ...
   * @param value The value of the property to set.
   */
  public static native void setPropertyAsString(JavaScriptObject object, String key,
                                                      String value) /*-{
    object[key] = value;
  }-*/;
   ...
   * @param value The value of the property to set.
   */
  public static native void setPropertyAsDouble(JavaScriptObject object,
   ...
   * @param value The value of the property to set.
   */
  public static native void setPropertyAsFloat(JavaScriptObject object,
   ...
   * @param value The value of the property to set.
   */
  public static void setPropertyAsLong(JavaScriptObject object, String key, long value) {
   ...
   * @param value The value of the property to set.
   */
  public static native void setPropertyAsInteger(JavaScriptObject object,
   ...
   * @param value The value of the property to set.
   */
  public static native void setPropertyAsBoolean(JavaScriptObject object,
   ...
   * @param key The name of the property to set.
   */
  public static void initArray(JavaScriptObject object, String key) {
   ...
   * @param key The name of the property to set.
   */
  public static native void clearArray(JavaScriptObject object, String key) /*-{
    object[key] = [];
  }-*/;
}
