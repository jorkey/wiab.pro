...
public class JsonMessage extends JavaScriptObject {
  ...
  private static String jsonMessageToJson(JsonMessage instance) {
  ...
  protected static void registerNativeJsonMessageToString(JsonMessage instance) {
    if (registerToString) {
   ...
   */
  private static native void nativeRegisterNativeJsonMessageToString(JsonMessage instance)
  /*-{
