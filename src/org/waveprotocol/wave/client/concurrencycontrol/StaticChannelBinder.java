...
public final class StaticChannelBinder {
  ...
  private final WaveDocuments<DiffContentDocument> docRegistry;
   ...
   */
  public static StaticChannelBinder create(
      WaveletOperationalizer operationalizer, WaveDocuments<DiffContentDocument> docRegistry) {
    return new StaticChannelBinder(operationalizer, docRegistry);
  }

  private StaticChannelBinder(WaveletOperationalizer operationalizer,
      WaveDocuments<DiffContentDocument> docRegistry) {
   ...
   *
   * @param waveletId id of the wavelet to bind
   * @param channel channel to bind
   */
  public void bind(String waveletId, OperationChannel channel) {
    ...
    OperationSucker.start(channel, asFlushing(waveletId, sinks.first));
