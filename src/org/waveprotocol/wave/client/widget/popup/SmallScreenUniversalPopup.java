...
/**
 * Class implementing UniversalPopup for clients with small screens.
 * 
 * Class is package private.
 */
class SmallScreenUniversalPopup implements UniversalPopup {
  ...
  private final List<PopupEventListener> listeners = new ArrayList<>();
   ...
   */
  SmallScreenUniversalPopup(Panel root) {
    this.root = root;
