...
/**
 * Class implementing popup factory for clients with small screens.
 */
public class SmallScreenPopupProvider implements PopupProvider {
  ...
  public UniversalPopup createPopup(Element reference, RelativePopupPositioner positioner,
    ...
    return new SmallScreenUniversalPopup(root);
  }
}
