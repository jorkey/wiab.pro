...
public interface PopupProvider {
   ...
   */
  UniversalPopup createPopup(
      Element relative, RelativePopupPositioner positioner,
      PopupChrome chrome, boolean autoHide);

  /**
   * Sets the root panel to be used for displaying pop-ups. Some platforms may
   * ignore this. Should be set before displaying any pop-ups.
   */
