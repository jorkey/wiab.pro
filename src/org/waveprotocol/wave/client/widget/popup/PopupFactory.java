...
/**
 * Creates pop-ups by deferring to a late-bound provider which may
...
public class PopupFactory {
   ...
   */
  public static UniversalPopup createPopup(
      Element relative,
      RelativePopupPositioner positioner,
      PopupChrome chrome,
      boolean autoHide) {
    return getProvider().createPopup(
        relative,
        positioner,
        chrome,
        autoHide);
  ...
  /**
   * Creates pop-ups suitable for current platform.
   */
