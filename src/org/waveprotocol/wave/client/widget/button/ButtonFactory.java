...
import org.waveprotocol.wave.client.widget.button.html.HtmlButton;
import org.waveprotocol.wave.client.widget.button.html.HtmlButtonWithHotkeyHint;
...
public class ButtonFactory {
  ...
  public static ClickButtonWidget createTextClickButton(String text,
    ...
    return createTextClickButtonWithTemplate(style, tooltip, listener, debugClassId, template);
  }

  /**
   * Create a click button with text, with specified template.
   *
   * @param style The style of the frame and background for the button.
   * @param tooltip The tooltip for the button.
   * @param listener The listener to be notified when the user clicks the
   ...
   * @return The button.
   */
  public static ClickButtonWidget createTextClickButtonWithTemplate(
      TextButtonStyle style, String tooltip, ClickButtonListener listener, String debugClassId, TextButton template) {
    ClickButton logic = new ClickButton();
    logic.setClickButtonListener(listener);
...
//      DebugClassHelper.addDebugClass(template, debugClassId);
  ...
  public static ClickButtonWidget createHtmlClickButton(String html,
      TextButtonStyle style, String tooltip, ClickButtonListener listener, String debugClassId) {
    TextButton template = new HtmlButton(html, style, tooltip);
    return createTextClickButtonWithTemplate(style, tooltip, listener, debugClassId, template);
  }

  public static ClickButtonWidget createHtmlClickButton(String html,
      TextButtonStyle style, String tooltip, ClickButtonListener listener) {
    return createHtmlClickButton(html, style, tooltip, listener, null);
  }

  public static ClickButtonWidget createHtmlButtonWithHotkeyHint(String label,
          boolean boldLabel, String hotKey, TextButtonStyle style, String tooltip, ClickButtonListener listener) {
    HtmlButtonWithHotkeyHint template = new HtmlButtonWithHotkeyHint(label, boldLabel, hotKey, style, tooltip);
    return createTextClickButtonWithTemplate(style, tooltip, listener, null, template);
  }
  /**
