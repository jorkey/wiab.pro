 ...
 */
public final class ProfilePopupPresenter implements ObservableConversation.ParticipantListener,
    ProfileListener, ProfilePopupView.Listener {
   ...
   * @param conversation conversation to be listened to
   * @return a new presenter.
   */
  public static ProfilePopupPresenter create(Profile model, final ProfilePopupView view,
      ProfileManager events, ObservableConversation conversation, SafeHtml buttonText,
      final Command buttonCommand) {
    ProfilePopupPresenter profileUi = new ProfilePopupPresenter(model, view, events, conversation);
    profileUi.init();
    
    // Add button to the profile card
    view.addButton(buttonText,
        new ClickHandler() {
          @Override
  ...
  public void onShow() {
    ...
    conversation.addParticipantListener(this);
  }
