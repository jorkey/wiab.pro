 ...
 * powerful control over their DOM and/or child life cycle.
 *
 ...
 *
 */
public class ImplPanel extends HTMLPanel implements LogicalPanel, RequiresResize,
    HasClickHandlers, HasDoubleClickHandlers, HasMouseDownHandlers, HasMouseMoveHandlers,
    SourcesEvents<ImplPanel.Listener> {
