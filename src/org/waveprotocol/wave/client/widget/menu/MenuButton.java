...
public final class MenuButton implements ButtonSwitch.Listener, Menu {
  ...
  @Override
  public MenuItem addItem(String title, final Command cmd, boolean enabled) {
    return menu.addItem(title, cmd, enabled);
  }

  @Override
  public MenuItem addItem(String title, String hotkey, final Command cmd, boolean enabled) {
    return menu.addItem(title, hotkey, cmd, enabled);
  }  
