...
/**
 * A handler of mouse come and leave events.
 */
public interface WaveMouseComeLeaveHandler {
  
  /**
   * Handles a mouse come / leave event.
   *
   ...
   *         false otherwise.
   */  
  boolean onMouseComeLeave(MouseComeLeaveEvent event, Element context);
}