...
public final class FocusManager implements Focusable, KeySignalHandler {
  ...
  private final static class DocumentPanel extends ComplexPanel
    ...
    private static boolean checkStatDialogCondition(int condition, int keyCode, boolean down) {
      return statDialogKeyCodeSequence[condition/2] == keyCode && ((condition & 1) == 0) == down;
    }
