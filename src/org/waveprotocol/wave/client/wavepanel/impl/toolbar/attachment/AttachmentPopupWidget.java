...
import org.waveprotocol.wave.client.wavepanel.impl.toolbar.attachment.i18n.AttachmentMessages;
...
public final class AttachmentPopupWidget extends Composite implements AttachmentPopupView,
  ...
  private final static AttachmentMessages messages = GWT.create(AttachmentMessages.class);
  ...
  public AttachmentPopupWidget() {
    ...
    // Workaround of https://code.google.com/p/google-web-toolkit/issues/detail?id=4682
    ...
    uploadBtn.addClickHandler(new ClickHandler() {
      ...
      public void onClick(ClickEvent event) {
        ...
        if (filename.length() == 0) {
          Window.alert(messages.nofileToUpload());
        } else {
