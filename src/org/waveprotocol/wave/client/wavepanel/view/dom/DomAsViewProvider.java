...
public interface DomAsViewProvider {
  ...
  /** @return {@code source} exposed as a placeholder. */
  PlaceholderView asPlaceholder(Element source);
  ...
  /** @return {@code source} exposed as an outline thread. */
  OutlineThreadView asOutlineThread(Element source);  
  ...
  ParticipantsView participantsFromAddButton(Element source);

  /** @return the tags view that surrounds the button {@code source}. */
