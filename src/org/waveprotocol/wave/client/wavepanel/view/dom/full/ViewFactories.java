...
public final class ViewFactories {
  ...
  private static abstract class BaseFactory
    ...
    public final InlineConversationViewBuilder createInlineConversationView(
        String id, UiBuilder participants, UiBuilder thread) {
      return InlineConversationViewBuilder.create(id, participants, thread);
    }
  }
   ...
   */
  public static final ViewFactory FLOW =
      new BaseFactory() {
        ...
        public TopConversationViewBuilder createTopConversationView(
          ...
          return FlowConversationViewBuilder.createRoot(id, participants, thread, tags);
        }
      };
   ...
   * context.
   */
  public static final ViewFactory FIXED =
      new BaseFactory() {

        @Override
        public TopConversationViewBuilder createTopConversationView(
            String id, UiBuilder participants, UiBuilder thread, UiBuilder tags) {
          return FixedConversationViewBuilder.createRoot(id, participants, thread, tags);
        }
      };
