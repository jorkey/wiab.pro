 ...
 *
 */
public final class ParticipantNameViewBuilder
    implements IntrinsicParticipantView, UiBuilder {

  public static ParticipantNameViewBuilder create(String id) {
    return new ParticipantNameViewBuilder(
        id, WavePanelResourceLoader.getParticipants().css());
  }  
  ...
  @VisibleForTesting
  private ParticipantNameViewBuilder(String id, Css css) {
    this.id = id;
    this.css = css;
  }
