...
public final class RootThreadViewBuilder implements IntrinsicThreadView, UiBuilder {
  ...
  @VisibleForTesting
  RootThreadViewBuilder(
      String id, HtmlClosure blips, UiBuilder replyBox, UiBuilder continuationIndicator, Css css) {
    this.css = css;
    this.id = id;
    this.blips = blips;
  ...
  public static RootThreadViewBuilder create(String id, HtmlClosure blips, UiBuilder replyBox,
    ...
    return new RootThreadViewBuilder(id, blips, replyBox, continuationIndicator,
        WavePanelResourceLoader.getRootThread().css());
  }

  public static RootThreadViewBuilder create(String id, UiBuilder clickToReply,
      UiBuilder continuationIndicator) {
    return create(id, HtmlClosure.EMPTY, clickToReply, continuationIndicator);
  }  
