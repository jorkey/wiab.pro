...
public final class AnchorDomImpl implements DomView {
  ...
  private static final String PARENT_ID_ATTRIBUTE = "pid";
  ...
  public void setParentId(String id) {
    ...
    if (self.hasAttribute(PARENT_ID_ATTRIBUTE)) {
      Preconditions.checkArgument(id == null);
      self.removeAttribute(PARENT_ID_ATTRIBUTE);
    } else {
      Preconditions.checkArgument(id != null && !id.isEmpty());
      self.setAttribute(PARENT_ID_ATTRIBUTE, id);
    }
  }
  ...
  public String getParentId() {
    return self.hasAttribute(PARENT_ID_ATTRIBUTE) ? self.getAttribute(PARENT_ID_ATTRIBUTE) : null;
  }
}
