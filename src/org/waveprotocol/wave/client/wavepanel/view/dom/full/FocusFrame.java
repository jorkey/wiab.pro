...
public final class FocusFrame implements FocusFrameView {
  ...
  public FocusFrame() {
    ...
    DomUtil.setElementType(element, View.Type.BLIP_FOCUS_FRAME);
  }  
  
  public static FocusFrame create() {
  ...
  public void setEditing(boolean editing) {
    DomUtil.addOrRemoveClassName(frame, css.editing(), editing);
    DomUtil.setElementBooleanAttribute(frame, EDITED_ATTRIBUTE, editing);
  }
}
