...
/**
 * Converter from conversation objects into view objects.
 */
public interface ModelAsViewProvider {
  ...
  OutlineThreadView getOutlineThreadView(ConversationThread source);
  ...
  /** @return the tag for {@code source}, if it exists. */
  TagView getTagView(Conversation conv, String tag);

  /** @return the tags for {@code source}, if they exist. */
   ...
   *         participantsUi}.
   */
  Conversation getConversation(ParticipantsView participantsUi);
  ...
  /**
   * @return the (mutable) tag collection represented by {@code
   *         tagsUi}.
   */
