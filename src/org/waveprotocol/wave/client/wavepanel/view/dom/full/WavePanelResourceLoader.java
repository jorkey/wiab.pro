...
public final class WavePanelResourceLoader {
  ...
  private final static DynamicRendererImpl.Resources render =
      GWT.create(DynamicRendererImpl.Resources.class);
  ...
  private final static ParticipantMessages participantMessages =
      GWT.create(ParticipantMessages.class);
  private final static TagMessages tagMessages =
      GWT.create(TagMessages.class);
  ...
  static {
    ...
    StyleInjector.inject(render.css().getText(), isSynchronous);
  }
  ...
  public static DynamicRendererImpl.Resources getRender() {
    return render;
  }
  ...
  public static ParticipantMessages getParticipantMessages() {
    return participantMessages;
  }

  public static TagMessages getTagMessages() {
    return tagMessages;
  }
