...
public interface BlipView extends View, IntrinsicBlipView {
  ...
  AnchorView insertDefaultAnchor(ConversationThread thread, AnchorView neighbor,
      boolean beforeNeighbor);

  void insertOutlineThread(ConversationThread thread);
  ...
  /** Detaches a thread from this blip. */
  void detach(OutlineThreadView view);
}
