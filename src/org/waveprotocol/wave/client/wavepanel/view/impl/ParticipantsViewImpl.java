...
public final class ParticipantsViewImpl<I extends IntrinsicParticipantsView> // \u2620
  ...
  public interface Helper<I> {
    ...
    ParticipantView append(
        I impl, Conversation conv, ParticipantId participant, WaveletOperationContext opContext,
        boolean showDiff);
  ...
  @Override
  public ParticipantView appendParticipant(
      Conversation conv, ParticipantId participant, WaveletOperationContext opContext,
      boolean showDiff) {
    return helper.append(impl, conv, participant, opContext, showDiff);
  }

  @Override
  public ParticipantView removeParticipant(
      Conversation conv, ParticipantId participant, WaveletOperationContext opContext,
      boolean showDiff) {
    return helper.remove(impl, conv, participant, opContext, showDiff);
  }  
