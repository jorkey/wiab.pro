...
public class TextSkippingView<N, E extends N, T extends N> extends FilteredView<N, E, T> {
  ...
  public static class Html extends TextSkippingView<Node, Element, Text> implements HtmlView {
     ...
     * @param rawView
     */
    public Html(ReadableDomDocument<Node, Element, Text> rawView) {
      super(rawView);
    }
  }
  ...
  public static class Content extends TextSkippingView<
     ...
     * @param rawView
     */
    public Content(ReadableDomDocument<ContentNode, ContentElement, ContentTextNode> rawView) {
      super(rawView);
    }
  }
   ...
   * @param rawView
   */
  public TextSkippingView(ReadableDomDocument<N, E, T> rawView) {
    super(rawView);
  }
