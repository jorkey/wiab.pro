...
import org.waveprotocol.wave.client.editor.content.paragraph.constants.ParagraphRenderingConstants;
...
public class DefaultParagraphHtmlRenderer implements ParagraphHtmlRenderer {
  ...
  @Override
  public void updateRendering(HasImplNodelets element, String type, String listStyle,
      int indent, Paragraph.Alignment alignment, Paragraph.Direction direction) {
    ...
    int margin = (indent == 0) ? 0 : ((indent-1) * ParagraphRenderingConstants.INDENT_UNIT_SIZE_PX);
    ...
    if (margin == 0) {
      ...
      if (direction == Paragraph.Direction.RTL) {
