...
public final class Editors {
  ...
  public static Editor create() {
    ...
    return UserAgent.isMobileWebkit() ? // \u2620
        new EditorImplWebkitMobile(true, e, null) : new EditorImpl(true, e, null);
  }
   ...
   *
   * @param doc document
   * @param blip conversation blip owning the document
   * @return New Editor instance
   */
  public static Editor attachTo(ContentDocument doc, ConversationBlip blip) {
    Element e = doc.getFullContentView().getDocumentElement().getImplNodelet();
    Preconditions.checkArgument(e != null);
    e = e.getParentElement();
    Preconditions.checkArgument(e != null);
    EditorImpl editor = UserAgent.isMobileWebkit()
        ? new EditorImplWebkitMobile(false, e, blip)
        : new EditorImpl(false, e, blip);
