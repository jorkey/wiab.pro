...
public final class CaretMovementHelperImpl implements CaretMovementHelper {
  ...
  private final ReadableDomDocument<ContentNode, ContentElement, ContentTextNode> persistentView;
  private final SelectionHelper selectionHelper;

  public CaretMovementHelperImpl(
      ReadableDomDocument<ContentNode, ContentElement, ContentTextNode> persistentView,
