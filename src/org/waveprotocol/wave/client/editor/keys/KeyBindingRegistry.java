...
public class KeyBindingRegistry {
  ...
  /** Register an action to be bound to combinations of the given task. */
  public void registerTask(KeyComboContext context, KeyComboTask task, EditorAction action) {
    for (KeyCombo combo : KeyComboManager.getKeyCombosByTask(context, task)) {
      if (combo != null) {
        registerAction(combo, action);
      }
    }
  }
