...
public class RestrictedRange<N> {
  ...
  public static <N, E extends N, T extends N> RestrictedRange<N> collapsedAt(
      ReadableDomDocument<N, E, T> doc, Point.El<N> collapsedAt) {
  ...
  public static <N, E extends N, T extends N> RestrictedRange<N> around(
      ReadableDomDocument<N, E, T> doc, N firstBoundedNode, N lastBoundedNode) {
  ...
  public static <N, E extends N, T extends N> RestrictedRange<N> between(
      ReadableDomDocument<N, E, T> doc, Point.El<N> before, Point.El<N> after) {
  ...
  public static <N, E extends N, T extends N> RestrictedRange<N> roundedBetween(
      ReadableDomDocument<N, E, T> doc, Point<N> before, Point<N> after) {
   ...
   */
  public <E extends N, T extends N> N getStartNode(ReadableDomDocument<N, E, T> doc) {
   ...
   */
  public <E extends N, T extends N> boolean contains(ReadableDomDocument<N, E, T> doc, N node) {
   ...
   */
  public <E extends N, T extends N> Point.El<N> getPointBefore(ReadableDomDocument<N, E, T> doc){
  ...
  private static <N, E extends N, T extends N> boolean isBetween(
      ReadableDomDocument<N, E, T> doc, N node, N fromIncl, N toExcl) {
