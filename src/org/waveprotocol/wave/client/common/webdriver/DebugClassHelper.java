...
public class DebugClassHelper {
   ...
   */
  public static void addDebugClass(UIObject uiObject, String debugClass) {
   ...
   * @param debugClass to be added
   */
  public static void addDebugClass(Element elem, String debugClass) {
   ...
   */
  public static void replaceDebugClass(
   ...
   */
  public static void removeDebugClass(UIObject uiObject, String debugClass) {
    Preconditions.checkNotNull(uiObject, "uiObject cannot be null");
   ...
   * @param debugClass to be removed
   */
  public static void removeDebugClass(Element elem, String debugClass) {
   ...
   */
  private static String joinDebugClasses(Set<String> debugClasses) {
   ...
   */
  private static Set<String> getDebugClasses(Element elem) {
