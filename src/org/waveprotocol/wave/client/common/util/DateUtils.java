...
public final class DateUtils {
  ...
  /**
   * Formats a date in the past to short definition, taking into account how long ago it was
   *
   * @param time The date to format, in ms since whenever
   * @return The formatted date
   */
  public String shortFormatPastDate(long time) {
    return shortFormatPastDate(new Date(time), new Date());
  }
