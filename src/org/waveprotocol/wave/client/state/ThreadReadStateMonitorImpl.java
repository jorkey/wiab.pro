 ...
 */
public final class ThreadReadStateMonitorImpl implements ThreadReadStateMonitor {
  ...
  public static ThreadReadStateMonitorImpl create(ObservableSupplementedWave supplementedWave,
    ...
    ThreadReadStateMonitorImpl monitor = new ThreadReadStateMonitorImpl(supplementedWave);
  ...
  private void init(ObservableQuasiConversationView conversationView) {
    ...
    // Listen to change of blip and wavelet read status.    
    ...
    // Listen to conversation adding or removing.
    ...
    if (conversationView.getRoot() != null) {
      bindConversation(conversationView.getRoot());
    }  
