...
public class CaretWidget implements CaretView {
  ...
  public void setColor(RgbColor color) {
    final String cssColor = color.getCssColor();
    compositionStateSpan.getStyle().setBorderColor(cssColor);
    outerSpan.getStyle().setBackgroundColor(cssColor);
    innerSpan.getStyle().setBorderColor(cssColor);
  }
