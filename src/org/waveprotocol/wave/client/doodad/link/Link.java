...
public final class Link {
  ...
  public static @Nullable String toHrefFromUri(String uri) {
    ...
    } catch (Link.InvalidLinkException e1) {
      return null;
    }
  ...
  public static String normalizeLink(String rawLinkValue) throws Link.InvalidLinkException {
    ...
    try {
      ...
      if (WaveRefConstants.WAVE_SCHEME.equals(scheme)) {
        ...
        throw new Link.InvalidLinkException("Unsupported URL scheme: " + scheme);
      }
      return WaveRefConstants.WAVE_URI_PREFIX + GwtWaverefEncoder.encodeToUriPathSegment(ref);
    } catch (InvalidWaveRefException e) {
      throw new Link.InvalidLinkException(INVALID_LINK_MSG, e);
    }
  }
