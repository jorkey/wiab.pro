...
import org.waveprotocol.wave.client.doodad.attachment.i18n.AttachmentMessages;
...
class ImageThumbnailWidget extends Composite implements ImageThumbnailView {
  ...
  private static AttachmentMessages messages = GWT.create(AttachmentMessages.class);
  ...
  public ImageThumbnailWidget() {
    ...
    button = ButtonFactory.createIconToggleButton(
        IconButtonStyle.PLUS_MINUS, messages.resizeImage(), new ToggleButtonListener() {
