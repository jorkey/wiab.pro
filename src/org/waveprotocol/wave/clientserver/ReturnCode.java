...
import org.waveprotocol.wave.communication.ProtoEnums.HasIntValue;

public enum ReturnCode implements HasIntValue{
  ...
  /** An operation was rejected by access control. */
  NOT_AUTHORIZED(3),
   ...
   */
  public static ReturnCode of(int value) {
