...
public final class RobotName {
  ...
  private static final Pattern ROBOT_LOCALHOST_ID_REGEX =
      Pattern.compile("^[a-z0-9._%+#-]+?@localhost$", Pattern.CASE_INSENSITIVE);
  ...
  public static boolean isWellFormedAddress(String address) {
    return address != null &&
        (ROBOT_ID_REGEX.matcher(address).matches() || ROBOT_LOCALHOST_ID_REGEX.matcher(address).matches());
  }
