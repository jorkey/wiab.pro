...
import org.waveprotocol.box.webclient.flags.WrappedJSObject;
import org.waveprotocol.box.webclient.flags.ExtendedJSObject;
...
public class WrappedJSObjectGwtTest extends GWTTestCase {
  ...
  private static native ExtendedJSObject getExtendedJSO() /*-{
    return {booleanValue:true, stringValue:'hello'};
  }-*/;

  private static WrappedJSObject getWrappedJSO() {
