...
public class OperationContextImplTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    waveletData.addParticipant(PARTICIPANT, null);
    ...
    when(waveletProvider.checkExistence(WAVELET_NAME)).thenReturn(true);
    when(waveletProvider.checkAccessPermission(WAVELET_NAME, PARTICIPANT)).thenReturn(true);
    when(waveletProvider.getSnapshot(WAVELET_NAME)).thenReturn(waveletData);
