...
import org.waveprotocol.wave.federation.WaveletFederationProvider.SubmitResultCallback;
...
public class XmppFederationRemoteTest extends TestCase {
  ...
  public void setUp() {
    ...
    manager = new XmppManager(host, remote, disco, transport, LOCAL_JID, Executors.newSingleThreadScheduledExecutor());
  ...
  public void testSubmitRequest() {
    ...
    ArgumentCaptor<SubmitResultCallback> remoteListener =
        ArgumentCaptor.forClass(SubmitResultCallback.class);
    verify(mockProvider)
