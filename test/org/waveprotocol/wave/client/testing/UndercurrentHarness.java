...
import org.waveprotocol.box.webclient.flags.NullTypedSource;
import org.waveprotocol.box.webclient.flags.OverridingTypedSource;
...
public class UndercurrentHarness implements EntryPoint {
  ...
  private final static class WaveFactory {
    ...
    private static WaveViewData createSampleWave() {
      ...
      WaveViewImpl<?> wave = WaveViewImpl.create(waveletFactory, waveData.getWaveId(), gen,
          sampleAuthor, WaveletConfigurator.ADD_CREATOR);
