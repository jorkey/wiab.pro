...
public class LazyPersistentContentDocumentGwtTest extends EditorGwtTestCase {
  ...
  private static boolean checkDomEqual(
      ReadableDomDocument<ContentNode, ContentElement, ContentTextNode> A,
      ReadableDomDocument<ContentNode, ContentElement, ContentTextNode> B) {
  ...
  private static String toSimpleString(ReadableDomDocument<ContentNode, ?, ?> doc) {
