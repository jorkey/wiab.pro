  ...
  public void onModuleLoad() {
    final EditorHarness editorHarness = new EditorHarness() {
        ...
        ImageThumbnail.register(registries.getElementHandlerRegistry(), attachmentManager,
          ...
          public boolean onClick(ImageThumbnailWrapper thumbnail) {
            ...
            String newId = Window.prompt("New attachment id, or 'remove' to remove the attribute",
                e.getAttribute(ImageConstants.ATTACHMENT_ATTRIBUTE));
            ...
            e.getMutableDoc().setElementAttribute(e, ImageConstants.ATTACHMENT_ATTRIBUTE, newId);
            return true;
          }
        });
      ...
      public String[] extendSampleContent() {
        ...
        return new String[] {
            "abcd" +
            ImageXmlUtil.constructXml(yosemite, "Yosemite").getXmlString() +
            ImageXmlUtil.constructXml(hills, "Hills").getXmlString() +
            ImageXmlUtil.constructXml(hills, true, "Hills").getXmlString(),
