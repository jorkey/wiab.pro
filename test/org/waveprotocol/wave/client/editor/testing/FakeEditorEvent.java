...
public class FakeEditorEvent extends FakeSignalEvent implements EditorEvent {
  ...
  public static FakeEditorEvent[] compositionSequence(int numUpdates) {
    ...
    evts[0] = create(JsEvents.COMPOSITION_START);
    for (int i = 1; i <= numUpdates; i++) {
      evts[i] = create(JsEvents.COMPOSITION_UPDATE);
    }
    evts[numUpdates + 1] = create(JsEvents.COMPOSITION_END);
    return evts;
  }
