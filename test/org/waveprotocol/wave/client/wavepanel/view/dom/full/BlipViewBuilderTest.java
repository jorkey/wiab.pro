...
public class BlipViewBuilderTest
    extends TestCase {

  private BlipViewBuilder.Css blipCss;
  ...
  public void testBasicContentAvailable() throws Exception {
    ...
    metaUi.setAvatar(avatar, authorName);
  ...
  public void testEvilHtmlEscaped() {
    ...
    String authorName = "evil";

    metaUi.setTime(evilTime);
    metaUi.setMetaline(evilLine);
    metaUi.setAvatar(evilAvatar, authorName);
