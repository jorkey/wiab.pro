...
public class OT3Test extends TestCase {
  ...
  private static final class TestConfig {
    ...
    public TestConfig reconnectToServer() throws Exception {
      ...
      serverConnectionMock.reconnect(clientMock.getReconnectionVersions(), null);
      return this;
    }
    ...
    public TestConfig serverDoOpen(int startVersion, int endVersion)
        throws ChannelException, TransformException, OperationException {
      List<WaveletOperation> operations = new ArrayList<>();
      if (startVersion != endVersion) {
        operations.add(new NoOp(new WaveletOperationContext(null, 0, 
          endVersion, genSignature(endVersion))));
      }
  ...
  public void testRecovery() throws Exception {
    ...
    t.serverDoOpen(1, 3).checkClientSentOps(3, 2);
    ...
    // Reconnect
    t.reconnectToServer().checkClientSentOpen(0, 1, 2);
    t.serverDoOpen(2, 3).checkClientSentOps(3);
    ...
    t.serverDoOpen(1, 4).checkClientSentOps(4);
    ...
    // Reconnect
    t.reconnectToServer().checkClientSentOpen(0, 1);
    t.serverDoOpen(1, 3).checkClientSentOps(3);
  ...
  public void testRecoveryMultipleTimes() throws Exception {
      ...
      // Reconnect again
      t.reconnectToServer().checkClientSentOpen(1);
      // Resend delta containing c1
      t.serverDoOpen(1, 1).checkClientSentOps(1, 2);
  }
