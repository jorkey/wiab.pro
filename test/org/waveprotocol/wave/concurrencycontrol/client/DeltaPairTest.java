...
public class DeltaPairTest extends TestCase {
  ...
  public void testIsSame() throws TransformException {
    ...
    assertEquals(2, pair.getServer().size());
    checkVersionUpdate(pair.getServer().get(0), null);
    checkVersionUpdate(pair.getServer().get(1), resultingVersion);
  }

  private void checkVersionUpdate(WaveletOperation operation, HashedVersion distinctVersion) {
