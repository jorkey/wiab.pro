 ...
 */
public class ServerConnectionMock
  ...
  public void reconnect(List<HashedVersion> signatures, WaveletDelta unacknowledgedDelta)
      throws ChannelException, WaveletStateException {
    reconnectSignatures.addAll(signatures);
    if (serverMock != null) {
      try {
        serverMock.reOpen(this, signatures, unacknowledgedDelta);
  ...
  public void triggerOnOpen(HashedVersion startSignature, HashedVersion endSignature,
    ...
    listener.onOpen(startSignature, endSignature, operations, unacknowledgedDeltaVersion);
  }
}
