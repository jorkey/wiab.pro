...
public class OperationChannelImplTest extends TestCase {
  ...
  private void connectChannel(long version, byte[] signature) throws ChannelException {
    ...
    operationChannel.onConnection(signatureInfo, signatureInfo, null, Collections.EMPTY_LIST);
  }
   ...
   * the current version.
   */
  private void reconnectChannel(long connectVersion, byte[] connectSignature) throws ChannelException {
    reconnectChannel(connectVersion, connectSignature, connectVersion, connectSignature, null, null);
  }
  ...
  public void testSimpleNackAndReceive() throws Exception {
    ...
    try {
      operationChannel.onNack(new ReturnStatus(ReturnCode.OK), 43);
  ...
  public void testSendToInaccessibleChanneFails() throws ChannelException {
    ...
    operationChannel.setListener(listener);
    operationChannel.onConnection(connectSig, connectSig, null, Collections.EMPTY_LIST);
  ...
  public void testReconnectFailureWithAckAndPendingAckWithCollidingVersionNumber()
    ...
    reconnectChannel(43, ackSignature, 47, SIG3, HashedVersion.of(47, SIG3), null);
