 ...
 */
public class MockMuxListener implements OperationChannelMultiplexer.ChannelsPresenceListener,
    OperationChannelMultiplexer.StreamListener {
  ...
  public void onOperationChannelCreated(OperationChannel channel, 
      ObservableWaveletFragmentData snapshot, Accessibility accessibility) {
    methodCalls.add(
  ...
  public void verifyConnected() {
    MethodCallContext context = methodCalls.remove();
    assertEquals(MethodCall.ON_CONNECTED, context.method);
  }
