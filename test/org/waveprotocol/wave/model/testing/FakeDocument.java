...
public class FakeDocument extends ObservablePluggableMutableDocument {
  ...
  public static class Factory implements DocumentFactory<FakeDocument> {
    ...
    @Override
    public FakeDocument create(WaveletId waveletId, String documentId, DocInitialization content) {
      return new FakeDocument(getSchemaForId(waveletId, documentId), content);
    }
  }

  private DocOp consumed;

  public FakeDocument(DocumentSchema schema, DocInitialization content) {
