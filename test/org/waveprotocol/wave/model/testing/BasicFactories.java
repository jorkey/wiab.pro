...
public class BasicFactories {
   ...
   * implementation.
   */
  private static final DocumentProvider<Document> DOC_PROVIDER =
      new DocumentProvider<Document>() {
  ...
  /**
   * Returns a new wavelet fragment data impl factory whose document schemas comes from
   * the current provider.
   */
  public static WaveletFragmentDataImpl.Factory waveletFragmentDataImplFactory() {
    return WaveletFragmentDataImpl.Factory.create(observablePluggableMutableDocumentFactory());
  }
