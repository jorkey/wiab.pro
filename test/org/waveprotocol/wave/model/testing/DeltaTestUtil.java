...
public class DeltaTestUtil {
  private static final WaveletOperationContext DUMMY = new WaveletOperationContext(null, 0L);
  ...
  public WaveletOperation delete(int posStart, String characters, int remaining) {
    DocOp op = new DocOpBuilder()
        ...
        .retain(remaining)
        .build();
    BlipContentOperation blipOp = new BlipContentOperation(new WaveletOperationContext(author, 0L, 1), op);
