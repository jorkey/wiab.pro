...
public class FakeWaveletDataListener implements WaveletDataListener {
  ...
  /**
   * The last tag received from
   * {@link #onTagAdded(WaveletData, tag)}
   */
  private String tagAdded;

  /**
   * The last tag received from
   * {@link #onTagRemoved(WaveletData, tag)}
   */
  ...
  @Override
  public void onParticipantAdded(ParticipantId participantId,
      WaveletOperationContext opContext) {
    this.participantAdded = participantId;
  }

  @Override
  public void onParticipantRemoved(ParticipantId participantId,
      WaveletOperationContext opContext) {
  ...
  /**
   * @return the last tag received by
   *         {@link #onTagAdded(WaveletData, tag)}
   */
