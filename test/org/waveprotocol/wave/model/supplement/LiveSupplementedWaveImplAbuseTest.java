...
public class LiveSupplementedWaveImplAbuseTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    ObservableConversationView conversationView = WaveBasedConversationView.create(view, idgen);
  ...
  public void testEmptyEvaluationSet() {
    WantedEvaluationSet evaluationSet = supplementedWave.getWantedEvaluationSet(rootWavelet.getId());
  ...
  public void testInvalidEvalauationsIgnored() {
    ...
    WantedEvaluationSet set = supplementedWave.getWantedEvaluationSet(otherWavelet.getId());
  ...
  public void testMultipleEvaluationSets() {
    ...
    WantedEvaluationSet set1 = supplementedWave.getWantedEvaluationSet(rootWavelet.getId());
    assertEquals(CollectionUtils.immutableSet(eval1, eval3), set1.getEvaluations());

    WantedEvaluationSet set2 = supplementedWave.getWantedEvaluationSet(otherWavelet.getId());
