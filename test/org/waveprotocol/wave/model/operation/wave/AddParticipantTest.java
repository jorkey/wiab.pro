...
public class AddParticipantTest extends TestCase {
  ...
  public void testCannotAddSameParticipantTwice() throws OperationException {
    new AddParticipant(createContext(), CREATOR).apply(wavelet);
    ...
    new AddParticipant(createContext(), ANOTHER).apply(wavelet); // adding another is ok
  }
  ...
  public void testReverseOfAddParticipantIsRemoveParticipant() throws OperationException {
    assertEquals(
        ...
        new AddParticipant(createContext(), CREATOR).applyAndReturnReverse(wavelet));
  }
