...
import org.waveprotocol.wave.model.document.dom.impl.DomDocumentImpl;
...
public class DocHelperTest extends TestCase {
  ...
  private void checkGetLocation(String docXml, int nodeLocation, int expectedLocation)
    ...
    DomDocument<Node, Element, Text> fullDoc =
        DomDocumentImpl.PROVIDER.create("doc", Attributes.EMPTY_MAP);
  ...
  public void testGetNextSiblingElementBackwards() {
    ReadableDocument<Node, Element, Text> doc = DocProviders.POJO.parse(
  ...
  public void testGetElementWithTagName() {
    ReadableDomDocument<Node, Element, Text> doc;
    {
   ...
   * {@link DocHelper#getElementWithTagName(ReadableDomDocument, String)} and
   * {@link DocHelper#getText(ReadableDomDocument, LocationMapper, Object)} .
   */
  ...
  private List<Point<Node>> splitTextNodes(IndexedDocument<Node, Element, Text> doc) {
    ...
    DocHelper.traverse(doc, doc.getDocumentElement(),
        new NodeAction<Node>() {
