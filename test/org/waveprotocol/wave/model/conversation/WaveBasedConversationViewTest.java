...
public class WaveBasedConversationViewTest extends ConversationViewTestBase {
  ...
  public void setUp() throws Exception {
    ...
    this.waveBasedConversationView = WaveBasedConversationView.create(waveView, idGenerator);
  }
  ...
  public void testCreateUsesConversationalId() {
    WaveBasedConversationView target = WaveBasedConversationView.create(waveView, idGenerator);
