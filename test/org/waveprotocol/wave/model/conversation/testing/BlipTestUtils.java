...
import org.waveprotocol.wave.model.conversation.testing.*;
...
public final class BlipTestUtils {
  ...
  public static int getBodyPosition(ConversationBlip blip) {
    return getBodyPosition(blip.getDocument());
  }
   ...
   */
  public static <N, E extends N> int getBodyPosition(ReadableDocument<N, E, ?> doc) {
