...
public class DocumentBasedElementListTest extends TestCase {
  ...
  private static class ListChangeObserver
    ...
    @Override
    public void onValueAdded(BasicValue<String> entry, BasicValue<String> previous,
        WaveletOperationContext opContext) {
      history.add("a");
    }

    @Override
    public void onBeforeValueRemoved(BasicValue<String> entry, WaveletOperationContext opContext) {
    }

    @Override
    public void onValueRemoved(BasicValue<String> entry, WaveletOperationContext opContext) {
      history.add("r");
    }
